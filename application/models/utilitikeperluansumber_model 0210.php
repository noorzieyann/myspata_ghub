...
class Utilitikeperluansumber_model extends CI_Model {
  ...
  function __construct() 
    ...
    //function untuk add new form sumber manusia
    function tambahsumbermanusia($utiliti_sumber_man_id)
    {
        $data = array(     'utiliti_sumber_man_id' => $this->input->post('utiliti_sumber_man_id'),        
                            ...
                            'kump_pengguna_id' => $this->input->post('peranan'),
                            'level_id' => $this->input->post('level'),
                            'jawatan' => $this->input->post('jawatan'),
                            'gred_jawatan' => $this->input->post('gredjawatan'),
                            'panel_penilai_kategori_id' => $this->input->post('disiplin'),
    ...
    function get_disiplin($panel_penilai_kategori_id)
    {
        $this->db->select('kategori');
        $this->db->where('panel_penilai_kategori_id',$panel_penilai_kategori_id);
        $getList = $this->db->get('lkp_panel_penilai_kategori');
        return $getList->result();
    }
   ...
   //function tambah syarikat
    function tambahsyarikat($syarikat_id)
    {
        $data = array(  'syarikat_id' => $this->input->post('syarikat_id'),
                        'nama_syarikat' => $this->input->post('nama_syarikat'),
