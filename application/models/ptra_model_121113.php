...
//function untuk add new model struktur ptra
	function tambahtreeviewptra()
    {
		...
		//echo "skop"; print_r($input1);
		//$input2 = $this->input->post('keterangan');
		//echo "<br/>keterangan"; print_r($input2);
		...
		for($i=0;$i<count($input1);$i++)
		{
			...
			//if($t > 0)
			//{
			//  $data3[$i]['keterangan'] = $input2[$input1[$i]];
			 //echo $input2[0];
			//}
			//else
			//{
 ...
 // print_r($delete);
   ...
   for($i=0;$i<count($insert);$i++){
    ...
    //$data3['ptra_id'] = $this->uri->segment(4);
   ...
   $this->db->insert('tbl_ptra_pata_f6_1b_skop_pilihan', $data); 
     
  //  $this->db->insert_batch('tbl_ptra_pata_f6_1b_skop_pilihan', $data3);
  }
    //update
      //$data4 = array();
 ...
 for($i=0;$i<count($update);$i++){
    ...
    //$data4[$i]['ptra_pata_f6_1b_skop_pilihan_id']=$update[$i];
   ...
   $this->db->where('ptra_id', $this->uri->segment(4));
   $this->db->update('tbl_ptra_pata_f6_1b_skop_pilihan', $data); 

      }
   //$this->db->update_batch('tbl_ptra_pata_f6_1b_skop_pilihan', $data4,'ptra_pata_f6_1b_skop_pilihan_id');
