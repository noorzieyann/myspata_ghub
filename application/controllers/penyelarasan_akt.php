   ...
   function  senarai_penyelarasan_akt($offset = 0)
	 {
      ...
      $data['status'] = $this->penyelarasan_akt_model->get_status();
    ...
    function penyelarasan_akt_pof()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyelarasan_akt_pof';
    ...
    function penyelarasan_akt_ketua_jab()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyelarasan_akt_ketua_jab';
    ...
    function penyediaan_penyelarasan_akt_pp()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyediaan_penyelarasan_akt_pp';
    ...
    function penyediaan_penyelarasan_akt_ketua_jab()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyediaan_penyelarasan_akt_ketua_jab';
    ...
    function penyediaan_penyelarasan_akt_ptf()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyediaan_penyelarasan_akt_ptf';
    ...
    function penyediaan_penyelarasan_akt_pof()
   {       
      $node_id = '126';
      $menu_name = 'menu1';
      $menu_link = 'belanjawan/pspao_pelarasan_aktiviti/penyediaan_penyelarasan_akt_pof';
