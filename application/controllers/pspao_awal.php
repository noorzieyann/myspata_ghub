...
//$data['detail_msg'] = $this->function_model->get_masej($pspao_awal_id,1);
        $data['main_content'] = 'alert';
        $data['msg'] = 'Borang PSPA(O) Awal telah berjaya dihantar.Klik butang OK untuk kembali ke Senarai PSPA(O) Awal.';
        $data['link'] = 'pspao_awal/senarai_pspao_baru';
     ...
     // echo "simpan";
      ...
      /* insert notifikasi */
       ...
       $idstatuslog = $this->pspao_model->insert_status_log($pspaid,1);
        ...
        //$data['detail_msg'] = $this->function_model->get_masej($pspao_awal_id,1);
        $data['main_content'] = 'alert';
        $data['msg'] = 'Anda telah berjaya menyimpan deraf PSPA(O)Awal.Klik butang OK untuk kembali ke Senarai PSPA(O) Awal.';
        $data['link'] = 'pspao_awal/senarai_pspao_baru';
     $this->load->view('template/default',$data);
      //redirect(site_url('pspao_awal/senarai_pspao_baru'));
    ...
    $data['ulasan'] = $this->pspao_model->get_ulasan_terbaru($pspaid,1);
     ...
     /*****hantar notifikasi kepada ppd yg pspao dh diluluskan*****/
      ...
      $pspao_awal_ppd_id   = $this->pspao_model->get_pspao_ppd_id($pspaid); // get ppd id
       ...
       $this->function_model->insert_notifikasi(15,7,$sessionarray['user_id'],$pspao_awal_ppd_id,$path3); //insert notifikasi
       ...
       $kjabatan_agensi_id = $this->pspao_model->get_ketua_jab_agensi_id($sessionarray['user_kemid']); //get ketua jabatan/agensi id
        ...
        foreach($kjabatan_agensi_id as $row){
         ...
         $path4 = 'pspao/arahan_sedia_pspao_akhir_ptf/'.$pspaid; //kusang update
       ...
       /******** end **********/
 $data['main_content'] = 'alert';
        $data['msg'] = 'Borang PSPA(O) Awal telah berjaya diluluskan.Klik butang OK untuk kembali ke Senarai PSPA(O) Awal.';
        $data['link'] = 'pspao_awal/senarai_pspao_baru';
 ...
 $data['main_content'] = 'alert';
  ...
  function ukuran_sasar_ptf($pspaid){
     ...
     if($this->input->post('sah')=='sah'){
      ...
      $data['main_content'] = 'alert';
        $data['msg'] = 'Borang PSPA(O) Awal telah berjaya disahkan.Klik butang OK untuk kembali ke Senarai PSPA(O) Awal.';
        $data['link'] = 'pspao_awal/senarai_pspao_baru';
