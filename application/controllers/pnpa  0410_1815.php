            ...
            if($this->form_validation->run())
            {
               ...
               // $data['pnpa_pata_f8_1a_modelstruktur_id'] = $this->session->userdata('pnpa_pata_f8_1a_modelstruktur_id');
                ...
                if($this->input->post('sunting')!= NULL)
                        ...
                        {
                           $$pnpa_pata_f8_1a_modelstruktur_id = $this->pnpa_model->tambahmodelpnpa($pnpa_pata_f8_1a_modelstruktur_id);  
                        }
                ...
                if($this->form_validation->run())
                    {
                        ...
                        $addTreeview = $this->pnpa_model->tambahtreeviewpnpa($pnpa_pata_f8_1b_skop_pilihan_id);
