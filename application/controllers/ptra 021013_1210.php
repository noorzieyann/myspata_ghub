...
function status_premis_ptra()
   ...
   function model_pif_ptra()
  {
    ...
    $node_id = '44';
    $menu_name = 'menu1';
    $menu_link = 'ptra/senarai_pif_ptra';
