         ...
         function summary_pnpa ()
  {
                ...
                if($getPnpa = $this->pnpa_model->get_pnpa2($id,$pnpa_id))
    {
     ...
     if($this->input->post('hantar') =='hantar')
         ...
         {
                $pnpa_sah_value =$this->pnpa_model->get_pnpa_sah_value($pnpa_id,$pspa_id); //check date untuk pspao sah
                   

                 if($pnpa_sah_value != '0000-00-00')
                     {
                          $this->pnpa_model->insert_status_log($id,4,$pnpa_id);; //insert status
                      ...
                      {
                          $this->pnpa_model->insert_status_log($id,2,$pnpa_id);; //insert status

                          /****** hantar notifikasi kpd pif or pof or ptf untuk disahkan ******/
                            ...
                            $path = 'pnpa/summary_pof_pnpa/'.$id.'/'.$pnpa_id;
                            $this->function_model->insert_notifikasi(52,4,$sessionarray['user_id'],$this->pnpa_model->get_pofid_pnpa($id,1),$path); 
                            
                            $path1 = 'pnpa/summary_ptf_pnpa/'.$id.'/'.$pnpa_id;
                            $this->function_model->insert_notifikasi(48,4,$sessionarray['user_id'],$this->pnpa_model->get_ptfid_pnpa($id,1),$path1); 
                 ...
                 if($this->input->post('lulus')=='lulus')
                     {
                       ...
                       /*****hantar notifikasi kepada ppd yg pnpa dah diluluskan*****/
                        $path4 = 'pnpa/summary_ppd_pnpa/'.$id.'/'.$pnpa_id;
    ...
    //nama:yann
        ...
        if($this->input->post('sah') == 'sah')
                    ...
                    /****** hantar notifikasi kpd ppd ada pnpa telah disahkan******/
                           $path2 = 'pnpa/summary_ppd_pnpa/'.$id.'/'.$pnpa_id;
                        ...
                        $this->pnpa_model->insert_status_log_ulasan($id,3,$pnpa_id); //insert status & ulasan
                         ...
                         /****** hantar notifikasi kpd ppd ada pspao perlu dibetulkan ******/
                          ...
                          //$pspao_awal_ppd_id   = $this->pspao_model->get_pspao_ppd_id($pspaid); // get ppd id
                           ...
                           $path3 = 'pnpa/summary_ppd_pnpa/'.$id.'/'.$pnpa_id;
