   ...
   $data['user_list'] = $this->pnpa_model->get_user_pelan_list($user_kemid,6);
    ...
    if($this->input->post('hantar')=='hantar'){
      ...
      if($this->input->post('pla')!='' && $i==0)
        ...
        $noti_id=$this->function_model->insert_notifikasi(42,4,'',$userid[0],$path,$strnew); 
 ...
 function arahan_penyediaan_pnpa_pif($id)
  {
    ...
    if($this->input->post('hantar')=='hantar'){
      ...
      if($this->input->post('pla')!='' && $i==0)
        ...
        $noti_id=$this->function_model->insert_notifikasi(43,4,'',$userid[0],$path,$strnew); 
  ...
  function arahan_penyediaan_pnpa_ppd()
  {
   ...
   if($this->input->post('hantar')=='hantar'){
      ...
      if($this->input->post('pla')!='' && $i==0)
        ...
        $noti_id=$this->function_model->insert_notifikasi(40,4,'',$userid[0],$path,$strnew); 
         ...
         function summary_pnpa ()
  {
                ...
                if($getPnpa = $this->pnpa_model->get_pnpa2($id,$pnpa_id))
    {
      ...
      if($this->input->post('hantar') == 'hantar'){
          ...
          $this->function_model->insert_notifikasi(52,4,$sessionarray['user_id'],$this->pnpa_model->get_pifid_pnpa($id),$path); 
                ...
                if($getPnpa = $this->pnpa_model->get_pnpa2($id,$pnpa_id))
                {
                 ...
                 /*****hantar notifikasi kepada ppd yg pspao dh diluluskan*****/
                  ...
                  //$pspao_awal_ppd_id   = $this->pspao_model->get_pspao_ppd_id($pspaid); // get ppd id
                   ...
                   $path = 'pnpa/summary_pp_pnpa_lulus/'.$id.'/'.$pnpa_id;

                   $this->function_model->insert_notifikasi(11,4,$sessionarray['user_id'],$this->pnpa_model->get_ppdid_pnpa($id,$pnpa_id),$path); //insert notifikasi
                   ...
                   $path2 = 'pnpa/summary_pp_pnpa_lulus/'.$id.'/'.$pnpa_id;

                   $this->function_model->insert_notifikasi(113,4,$sessionarray['user_id'],$this->pnpa_model->get_pifid_pnpa($id),$path2); //insert notifikasi
...
//                     $path4 = 'pspao/arahan_sedia_pspao_akhir_ptf';
 ...
 /******** end **********/
                    $data['main_content'] = 'alert';
                    $data['msg'] = 'Borang PNPA telah berjaya diluluskan.Klik butang OK untuk kembali ke Senarai PSPA(O) Awal.';
                        ...
                        $this->pnpa_model->insert_status_log_ulasan($id,3,$pnpa_id); //insert status & ulasan
                         ...
                         /****** hantar notifikasi kpd ppd ada pspao perlu dibetulkan ******/
                          ...
                          //$pspao_awal_ppd_id   = $this->pspao_model->get_pspao_ppd_id($pspaid); // get ppd id
                           ...
                           $this->function_model->insert_notifikasi(59,4,$sessionarray['user_id'],$this->pnpa_model->get_ppdid_pnpa($id,$pnpa_id),$path2); //insert notifikasi
