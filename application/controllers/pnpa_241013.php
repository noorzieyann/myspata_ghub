    ...
    function kemaskinikawalan_rekod()
         {
                ...
                $pnpa__id = $this->uri->segment(3);

                if($getKawalanrekod = $this->pnpa_model->get_kawalanrekod_1($pnpa__id))
                {
                    $data['senarai_kawalan'] = $getKawalanrekod;
       ...
       function dokumen_rujukan_pnpa ()
 {
    ...
    */
    ...
    $lampiran_id = $this->uri->segment(3); 
     ...
     //upload file begin here : not use ci code
     if(!empty($_FILES['nama_fail_asal1']))
     {
      if ($_FILES["nama_fail_asal1"]["error"] > 0)
        ...
        {
       $uphere = move_uploaded_file($_FILES['nama_fail_asal1']['tmp_name'], 'uploads/'.$_FILES["nama_fail_asal1"]["name"]);
       ...
       else
       {
        ...
        //$addDoc = $this->pnpa_model->tambahdokumen($lampiran_id,$_FILES["nama_fail_asal1"]["name"]);
        $addDoc = $this->pnpa_model->tambahdokumen($_FILES["nama_fail_asal1"]["name"]);
