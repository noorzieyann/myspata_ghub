...
*/
	...
	function pilih_role($id){
			...
			$this->db->select('tbl_myspata_user.myspata_userid, tbl_user_matrix.role_pengguna_id, tbl_user_matrix.kump_pengguna_id, tbl_user_matrix.nama_kump_pengguna, tbl_user_matrix.role_pengguna');
			...
			foreach($query->result() as $dtrow){
				...
				$data_radio[$dtrow->role_pengguna_id] = $dtrow->nama_kump_pengguna.' ('.$dtrow->role_pengguna.')';
			}
