...
////////// 		BARU BUAT UNTUK 2 USER PTF DAN PPD ///////////// 		17 OCT 2013
 ...
 ////////// 		BARU BUAT UNTUK 2 USER PTF DAN PPD ///////////// 		17 OCT 2013
        ...
        function pspao_akhir_baru()
        {
			...
			//update by azian 1910
			$pp= $this->input->post('pp');
            $sesskey= $this->input->post('sesskey');
        ...
        function pspao_akhir_baru_4($id)
        {
			...
			if($this->input->post('hantar') == 'Hantar'){
				...
				//update by azian 1910
				$pspao_ptf_id   = $this->pspao_akhir_model->get_pspao_akhir_ptf_id($pspao_id); // get ptf id
				$path = 'pspao/senarai_pspao_akhir_ptf_2/'.$pspao_id;
