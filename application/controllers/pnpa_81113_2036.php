  ...
  function kemaskinipanel_penilai_pnpa()
    {
                ...
                $data['senarai_panel2'] = $this->pnpa_model->get_panelpenilai_1($this->uri->segment(5));
                $data['peranan'] = $this->utilitikeperluansumber_model->get_peranan_1();
                $data['disiplin'] = $this->utilitikeperluansumber_model->get_bidang_1();
                $data['syarikat'] = $this->utilitikeperluansumber_model->get_syarikat_1();
                $data['jabatan'] = $this->utilitikeperluansumber_model->get_jabatan_agen();
                ...
                if($this->form_validation->run())
                {
                    ...
                    $dataDetail = array(       
                                        ...
                                        //print_r($dataDetail);
                    //die();
                    $update_panel = $this->pnpa_model->update_panel($this->uri->segment(5), $dataDetail);
                    ...
                    else
                    {
                        ...
                        redirect('pnpa/kemaskinipanel_penilai_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),'refresh');
                    } 
                }
...
//edited by : fatin 8/11/13
 function kemaskinipanel_penilai_pnpa2()
    {
            
        
                $node_id = '14';
                $menu_name = 'menu1';
                $menu_link = 'pnpa/kemaskinipanel_penilai_pnpa2';
                ...
                if($this->form_validation->run())
                {
                    ...
                    {
                        $this->session->set_flashdata('flashError', '<strong><font color="red" size="2">AMARAN: Gagal mengemaskini rekod.</font><br></strong><br>');
                        redirect('pnpa/kemaskinipanel_penilai_pnpa2/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),'refresh');
                    } 
                }
...
function kemaskinikawalan_rekod_ptf()
  ...
  */
         ...
         function summary_pnpa ()
  {
                ...
                if($getstatus = $this->function_model->check_status_log1($id,4,$pnpa_id))
                 {
  ...
  function kemaskinipanel_penilai_pnpa_ppd()
    {
                ...
                if($this->form_validation->run())
                {
                    ...
                    {
                        $this->session->set_flashdata('flashError', '<strong><font color="red" size="2">AMARAN: Gagal mengemaskini rekod.</font><br></strong><br>');
                        redirect('pnpa/kemaskinipanel_penilai_pnpa_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),'refresh');
                    } 
                }
    ...
    //edited by : fatin 8/11/13        
   function kemaskinipanel_penilai_pnpa_ppd2()
    {
            
        
                $node_id = '14';
                $menu_name = 'menu1';
                $menu_link = 'pnpa/kemaskinipanel_penilai_pnpa_ppd2';
                ...
                if($this->form_validation->run())
                {
                    ...
                    {
                        $this->session->set_flashdata('flashError', '<strong><font color="red" size="2">AMARAN: Gagal mengemaskini rekod.</font><br></strong><br>');
                        redirect('pnpa/kemaskinipanel_penilai_pnpa_ppd2/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),'refresh');
                    } 
                }
