...
function summary_ppd_popa_edit ()
  ...
  function senarai_ppd_popa($offset = 0)
	{
		//name: Seri Idayu
		//date: 08072013
  ...
  function model_struktur_popa($sort_by = 'title', $sort_order = 'asc', $offset = 0)
	{
		//name: Seri Idayu
		//date: 08072013
		//desc: model struktur popa
                ...
                $data_1 =   array(
                         array('1','Sivil','Zuhairi Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>',
                          ...
                          array   ('2','Sivil','sayuthi Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
                         ...
                         array ('3','Sivil','adib Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
                       ...
                       array ('4','Sivil','Hakim Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
                             ),
                      array ('5','Sivil','Hakim Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
                             ),
                      array ('6','Sivil','Hakim Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
                             ),
                      array ('7','Sivil','Hakim Mohd', 'ABC SDN BHD',
                             ' <ul class="icomoon-icons-container">
                          <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span> </li>
                        </ul>'
              ...
              $config['base_url'] = site_url('popa/model_struktur_popa');
              $config['total_rows'] = count($data_1);
              $config['uri_segment'] = 3;
              $config['per_page'] = $quantity;
              $config['num_links'] = 20;
              ...
              $this->table->set_heading(anchor("popa/model_struktur_ptra/",'Bil','title="Klik untuk susun rekod"'), 
                              anchor("popa//model_struktur_ptra/",'Kategori ID','title="Klik untuk susun rekod"'),
                              anchor("popa//model_struktur_ptra/",'Nama','title="Klik untuk susun rekod"'),
                              anchor("popa//model_struktur_ptra/",'Syarikat','title="Klik untuk susun rekod"'),
                              anchor("popa//model_struktur_ptra/",'Surat Lantikan','title="Klik untuk susun rekod"'),
                              anchor("popa//model_struktur_ptra/",'Tindakan','title="Klik untuk susun rekod"'));
