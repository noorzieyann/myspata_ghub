   ...
   function senarai_pif_pnpa()
  {
	...
	function treeview_pnpa ()
	{
               ...
               $skop_aktvt_id = $this->uri->segment(3);
                ...
                //$data['senarai_aktiviti'] = $this->pnpa_model->get_aktiviti($skop_aktvt_id);
                
               /* if($getSkop = $this->pnpa_model->get_skop())
                {
                   $data['senarai_skop'] = $getSkop;
                }

      */          if($getSkopAk = $this->pnpa_model->get_aktiviti($skop_aktvt_id))
                {
                   $data['senarai_aktiviti'] = $getSkopAk;
                }
