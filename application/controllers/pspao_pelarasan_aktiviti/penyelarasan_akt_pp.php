<!-- page: penyelarasan aktiviti pegawai pengawal, by seri idayu, 19092013 -->
...
<script type="text/javascript">
  ...
  $("pembetulan").onclick = function () 
  {
    ...
    alertify.confirm("Adakah ingin menghantar notifikasi pembetulan Pelan Penyelarasan Aktiviti ini?", function (e) 
    {
      if (e) 
      {
        window.location ="<?php echo site_url('penyelarasan_akt/senarai_penyelarasan_akt') ?>";
