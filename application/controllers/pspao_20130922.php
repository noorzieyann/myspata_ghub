...
//end table
        ...
        function senarai_pspao_akhir_ppd_2()
        {
			$node_id = '15';
			$menu_name = 'menu1';
			...
			$config['base_url'] = site_url('pspao/senarai_pspao_akhir_ppd_2');
			$config['total_rows'] = count($this->pspao_akhir_model->get_data_dummy());
			$config['uri_segment'] = 3;
			$config['per_page'] = $quantity;
	        $config['num_links'] = 20;
...
//end table
        ...
        function senarai_pspao_akhir_pp_2()
        {
			$node_id = '15';
			$menu_name = 'menu1';
			...
			$config['base_url'] = site_url('pspao/senarai_pspao_akhir_pp_2');
			$config['total_rows'] = count($this->pspao_akhir_model->get_data_dummy());
			$config['uri_segment'] = 3;
			$config['per_page'] = $quantity;
	        $config['num_links'] = 20;
...
//////////////////// baru punya senarai pspao //////////////////// natang 
        ...
        function senarai_pspao_akhir()
        {
			...
			$data['dataku'] = array_slice($this->pspao_akhir_model->get_data_dummy_all(), $start, $quantity);

			$config['base_url'] = site_url('pspao/senarai_pspao_akhir');
			$config['total_rows'] = count($this->pspao_akhir_model->get_data_dummy_all());
			$config['uri_segment'] = 3;
			$config['per_page'] = $quantity;
	        $config['num_links'] = 20;
            $config['full_tag_open'] = '<div id="data-table_paginate" class="dataTables_paginate paging_full_numbers">';
