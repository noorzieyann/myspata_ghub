 ...
 ////////// 		BARU BUAT UNTUK 2 USER PTF DAN PPD ///////////// 		17 OCT 2013
	...
	function pspao_akhir_baru_1($idakhir,$idawal=NULL){
		...
		*/
		...
		function hapus_pspao_akhir_lampiran_form5_ppd($id,$pspaoid,$kandid,$statusid){
			
			$url_betul = 'pspao/pspao_akhir_ppd_f5/'.$pspaoid.'/'.$kandid.'/'.$statusid;
			//echo $url_betul;
			$this->pspao_akhir_model->hapus_pspao_akhir_lampiran($id);
			redirect($url_betul,'refresh');
			...
			if($this->uri->segment(4)!=NULL)
                        {
                            ...
                            $this->aauth->set_session('user_noti',$this->uri->segment(4));  
                            //$_SESSION['NOTI'] = $this->uri->segment(4);
                        }
			$data['rows'] = $this->pspao_akhir_model->get_all_kandungan($id);
			$data['tahun_mula'] = $this->pspao_akhir_model->get_tahun_mula_pspao($id);
			$data['tahun_akhir'] = $this->pspao_akhir_model->get_tahun_akhir_pspao($id);
...
//////////////////// baru punya senarai pspao //////////////////// natang 
	...
	function check_user_login_page(){
        ...
        function pspao_akhir_pp_f1($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_pp_f1';
        ...
        function pspao_akhir_pp_f2($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_pp_f2';
        ...
        function pspao_akhir_pp_f3($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_pp_f3';
        ...
        function pspao_akhir_pp_f4($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_pp_f4';
        ...
        function pspao_akhir_pp_f5($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_pp_f5';
        ...
        function pspao_akhir_ptf_f1($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ptf_f1';
        ...
        function pspao_akhir_ptf_f2($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ptf_f2';
        ...
        function pspao_akhir_ptf_f3($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ptf_f3';
        ...
        function pspao_akhir_ptf_f4($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ptf_f4';
        ...
        function pspao_akhir_ptf_f5($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ptf_f5';
        ...
        function pspao_akhir_ppd_f1($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ppd_f1';
        ...
        function pspao_akhir_ppd_f2($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ppd_f2';
        ...
        function pspao_akhir_ppd_f3($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ppd_f3';
        ...
        function pspao_akhir_ppd_f4($id,$kandid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ppd_f4';
        ...
        function pspao_akhir_ppd_f5($id,$kandid,$sid){
			
			$node_id = '36';
			$menu_name = 'menu1';
			$menu_link = 'pspao_akhir/pspao_akhir_ppd_f5';
			...
			if($this->input->post('hantar')=='Tambah'){
					...
					else
					{
						...
						//$this->pspao_akhir_model->get_dokumenrujukan($idpspao);
						$this->pspao_akhir_model->tambah_dokumenrujukan($data_file);
						redirect('pspao/pspao_akhir_ppd_f5/'.$id.'/'.$kandid.'/'.$sid,'refresh');
						//print_r($data_file);
					}					
