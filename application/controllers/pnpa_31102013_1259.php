 ...
 function arahan_penyediaan_pnpa_pif($id)
  {
    ...
    if($this->input->post('hantar')=='hantar')
    {
      ...
      if($this->input->post('pla')!='' && $i==0)
        ...
        $noti_id=$this->function_model->insert_notifikasi(43,4,$user_kemid,$userid[0],$path,$strnew); 
  ...
  function kemaskinipanel_penilai()
    {
                ...
                if($this->form_validation->run())
                {
                    ...
                    else
                    {
                        ...
                        redirect('ptra/kemaskinipanel_penilai/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$ptra_pata_f6_1a_panel_penilai_id.'refresh');
                    } 
                }
