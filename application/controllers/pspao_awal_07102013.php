...
function check_user_login_page(){
     ...
     $data = array('menu_name' => $menu_name, 'menu_id' => $node_id, 'main_content' => $menu_link);
      ...
      if ($this->form_validation->run() == FALSE){
       ...
       $this->function_model->insert_notifikasi(4,1,$sessionarray['user_id'],$pspao_awal_ptf_id,$path);  //insert notifikasi
        ...
        //$this->load->view('template/default',$data);
       redirect('pspao_awal/senarai_pspao_baru','refresh');
  ...
  function pspao_baru_copy($pspaoid)
  {
        ...
        function ulasan_pp_lulus_pspao($id)
	{
       ...
       $this->function_model->insert_notifikasi(9,1,$sessionarray['user_id'],$pspao_awal_ppd_id,$path); //insert notifikasi
       ...
       $this->function_model->insert_notifikasi(9,1,$sessionarray['user_id'],$pspao_awal_ptf_id,$path2); //insert notifikasi
       ...
       // print_r($kjabatan_agensi_id);
        ...
        for($i=0;$i<$count_row;$i++){
         ...
         $this->function_model->insert_notifikasi(23,1,$sessionarray['user_id'],$kjabatan_agensi_id[$i],$path3); //insert notifikasi
