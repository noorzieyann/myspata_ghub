...
///////////////// -PSPAO Akhir- -START- //////////////
        ...
        function senarai_pspao_akhir_ptf()
        {
			...
			$config['base_url'] = site_url('pspao/senarai_pspao_akhir_ptf');
			...
			if ($this->form_validation->run() == FALSE){
				...
				$data['main_content'] = 'pspao/senarai_pspao_akhir_ptf';
				$this->load->view('template/default', $data);
			}
...
//end table
        ...
        function senarai_pspao_akhir_ketuajab()
        {
			...
			if ($this->form_validation->run() == FALSE){
				...
				$data['main_content'] = 'pspao/senarai_pspao_akhir_ketuajab';
				$this->load->view('template/default', $data);
			}
