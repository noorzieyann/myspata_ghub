  ...
  <div class="tab-content" id="myTabContent">
    <div id="home" class="tab-pane fade active in">
      ...
      <div class="main-container">
        ...
        <!--popup-->
    <?php echo form_open_multipart('pnpa/dokumen_rujukan_pnpa_edit_ppd');?>
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table" >    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('pnpa/muat_dokumen_rujukan_pnpa_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>"><?php echo $rec->nama_fail_asal; ?></a></td>
                                <td align="center">
                                    <ul class="icomoon-icons-container">
                                    <a class="confirmation" href="<?php echo site_url('pnpa/hapus_dokumen_rujukan_pnpa_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>"><li class="rounded"><span class="fs1" data-icon="&#xe0a7" aria-hidden="true" id="hapus1" ></span></li></a>                                    
                                    </ul>
                                </td>
                            </tr>
                            <?php echo form_close(); ?>
