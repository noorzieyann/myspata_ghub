<!--breadcrumb-->
	...
	if($this->uri->segment(3) != NULL){$form_name = 'pnpa/skop_aktiviti2_pnpa_edit_pp/'.$this->uri->segment(3);}
...
<?php echo validation_errors(); ?>
     ...
     <br />
      <div class="widget-body">
         ...
         <p>
         <form action='<?php echo site_url(); ?>pnpa/skop_aktiviti2_pnpa_edit_pp/<?php echo $this->uri->segment(3); ?>' method='post'>
