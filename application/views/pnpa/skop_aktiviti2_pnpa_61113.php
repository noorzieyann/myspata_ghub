    ...
    <?php echo validation_errors(); ?>
                    ...
                    <div class="overview">
                 	 <?php $total=0; ?>
                       ...
                       ?>      <label class="checkbox">
                               ...
                               <?php echo $rec->nama; ?>
                            <?php if($this->pnpa_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(3),1,$this->uri->segment(4),1)== FALSE)
     ...
     <!--end div tab -->
       ...
       <!--<form id="" class="" action="<?php echo site_url(); ?>/pnpa/sumberrancang" method="post"> -->
                  <div id="myModal<?php echo $rec->utiliti_sumber_man_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                      ...
                      <label class="radio"><input type="radio" name="kosflag" id="optionsRadios2" value="1">Gaji</label>

                      <label class="radio"><input type="radio" name="kosflag" id="optionsRadios2" value="2">Gaji dan Kos Lebih Masa</label>
                   <input type="hidden" name="utiliti_sumber_man_id" value="<?php echo $rec->utiliti_sumber_man_id; ?>" >
                   <input type="hidden" name="gaji" value="<?php echo $rec->gaji; ?>" >
                   <input type="hidden" name="kos" value="<?php echo $rec->kos_kerja_lebih_masa; ?>" >
                   ...
                   <input type="hidden" name="kat_sumber_man_id" value="1">
                    </div>
      ...
      <!-- </form> -->      
        ...
        <?php if(!empty($senarai_sumber)) : foreach ($senarai_sumber as $rec) : ?>
     <!--  <form id="" class="" action="<?php echo site_url(); ?>/pnpa/sumberrancang" method="post"> -->
                  <div id="myModal2<?php echo $rec->utiliti_sumber_man_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ×
                      </button>
                   ...
                   <input type="hidden" name="skop_aktvt_id" value="<?php echo $this->uri->segment(5)?>">
                   <input type="hidden" name="pnpa_id" value="<?php echo $this->uri->segment(4)?>">
                   <input type="hidden" name="kat_sumber_man_id" value="2">
                    </div>
                   <div class="modal-footer">
                   <a href="#" class="btn btn-danger input-top-margin" data-dismiss="modal">Batal</a>
                     <input type="submit" value="Simpan" class="btn btn-warning2">
      ...
      <!-- </form>   -->    
        ...
        <?php if(!empty($senarai_sumber)) : foreach ($senarai_sumber as $rec) : ?>
      <!-- <form id="" class="" action="<?php echo site_url(); ?>/pnpa/sumberrancang" method="post"> -->
                  <div id="myModal3<?php echo $rec->utiliti_sumber_man_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ×
                      </button>
                   ...
                   <input type="hidden" name="skop_aktvt_id" value="<?php echo $this->uri->segment(5)?>">
                   <input type="hidden" name="pnpa_id" value="<?php echo $this->uri->segment(4)?>">
                   <input type="hidden" name="kat_sumber_man_id" value="3">
                    </div>
                   <div class="modal-footer">
                   <a href="#" class="btn btn-danger input-top-margin" data-dismiss="modal">Batal</a>
                     <input type="submit" value="Simpan" class="btn btn-warning2">
