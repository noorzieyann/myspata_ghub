<!--breadcrumb-->
    ...
    <!--END breadcrumb-->
     <?php 
	$form_name = 'pnpa/model_struktur_pnpa_edit_pp';
	if($this->uri->segment(4) != NULL){$form_name = 'pnpa/skop_aktiviti2_pnpa_edit_pp/'.$this->uri->segment(4);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_pnpa_edit_pp');
...
<?php echo validation_errors(); ?>
     ...
     <br />
      <div class="widget-body">
         ...
         <p>
         <form action='<?php echo site_url(); ?>pnpa/skop_aktiviti2_pnpa_edit_pp/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4); ?>' method='post'>
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                          ...
                          <a href="<?php echo site_url('pnpa/papar_panel_penilai_pp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)).'/'.$rec->utiliti_sumber_man_id; ?>">                         
