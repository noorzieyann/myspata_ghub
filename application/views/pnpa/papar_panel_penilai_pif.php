                        ...
                        <?php if (!empty($senarai_panel)) : foreach ($senarai_panel as $rec) : ?>
                            ...
                            <form class="form-horizontal no-margin">
                              ...
                              <!--  <input type="hidden" name="no" value="<?php echo $rec->pnpa_id; ?>"> -->
                                ...
                                <div align="right">
                <a href="<?php echo site_url('pnpa/model_struktur_pnpa_edit_pif/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Kembali
                  </button></a>
           </div>
                            </form>
