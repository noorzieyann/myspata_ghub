  ...
  <div class="tab-content" id="myTabContent">
    ...
    <!--/.END status info-->
      ...
      <div class="main-container">
         ...
         <!--/.END panel 1-->
<?php
$attributes = array('class' => 'form-horizontal no-margin','name'  => 'summary_pif_pnpa','id'    => 'summary_pif_pnpa');
...
<?php ///////// body utama /////////// ?>
   ...
   <div class="next-prev-btn-container pull-right">
              <?php //echo form_hidden('alasanbelaka','') ?>
                <a type="button" class="btn btn-danger" href="<?php echo site_url('pnpa/senarai_ppd_pnpa/'.$this->uri->segment(3)) ?>" data-toggle="modal">Batal</a>
