                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                       ...
                       <?php $cnt=$this->pnpa_model->get_lkpskopbutiran_count($rr->skop_aktvt_id);
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url()?>/pnpa/skop_aktiviti2_pnpa_edit_pof/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4); ?>/<?php  echo $rrq->skop_aktvt_id; ?>">
