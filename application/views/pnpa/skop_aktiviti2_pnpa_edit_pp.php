...
<div class="widget-body">
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='pnpa/skop_aktiviti_pnpa_edit_pp/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
	if($this->uri->segment(3) != NULL){$form_name = 'pnpa/skop_aktiviti_pnpa_edit_pp/'.$this->uri->segment(4);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti_pnpa_edit_pp');
              ...
              <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'skop_aktiviti_pnpa_edit_pp',
                           'id' => 'skop_aktiviti_pnpa_edit_pp',
                        );
                    echo form_open('pnpa/skop_aktiviti_pnpa_edit_pp/'.$this->uri->segment(4).'/'.$this->uri->segment(4),$attributes); ?>
		...
		<div class="span12">
                ...
                <div class="widget-body">
                    ...
                    <input type="hidden" value="<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4)?>" name="no"> 
                     <input type="hidden" value="<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5)?>" name="skop_aktvt_id"> 
                    <div class="control-group">
 		...
 		<div class="span3">
                ...
                <div class="widget-body">
                    ...
                    <!--start div button -->
                <div align="right">
                <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa_edit_pp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Kembali
                  </button></a>
   		   </div>
                <!--end div button -->
