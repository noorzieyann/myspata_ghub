            ...
            <div class="span12">
             ...
             <table>  <tr><td>
              ...
              <?php 
                ...
                $pof='pof';
              echo form_dropdown('pegawai', $options, $pof); ?>
             </td><td width="20%"></td>
             <td>   
            ...
            <div class="span12">
              ...
              <div class="widget-body">
               <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'arahan_penyediaan_pnpa_pof',
                           'id' => 'arahan_penyediaan_pnpa_pof',
                        );
                    echo form_open('pnpa/arahan_penyediaan_pnpa_pof/'.$this->uri->segment(3),$attributes); ?>
               ...
               <div id="dt_example" class="example_alt_pagination">   
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Pegawai Operasi Fasiliti</td>
                        <td><?php
                              $data = array(
                              'name'        => 'userid[]',
                              'id'          => 'userid[]',
