                ...
                <div class="widget-body">
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                       ...
                       <?php if($getSko = $this->pnpa_model->get_lkpskop($this->uri->segment(3)))  :foreach ($getSko as $rr) :?> 
                        <tr>
                        <td><span class="name"><?php echo $i++; ?></span></td>
                        <td class="hidden-phone"> <?php echo $rr->skop_aktvt_tajuk;?></td>
                        
                        <?php   $loop_aktvt_cnt=0;
                                if($getSko = $this->pnpa_model->get_lkpskopaktiviti($rr->skop_aktvt_id, $this->uri->segment(3)))  :foreach ($getSko as $rrr) :
                                if($loop_aktvt_cnt >0 ):?>
                        </tr><tr><td></td><td></td>
                       ...
                       <?php $cnt=$this->pnpa_model->get_lkpskopbutiran_count($rr->skop_aktvt_id);
                         ...
                         <?php if($getSko = $this->pnpa_model->get_lkpskopbutiran($rrr->skop_aktvt_id,  $this->uri->segment(3)))  :foreach ($getSko as $rrq) :?>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url()?>/pnpa/skop_aktiviti2_pnpa/<?php echo $this->uri->segment(3) ?>/<?php  echo $rrq->skop_aktvt_id; ?>">
...
<input class="input-large" placeholder="80000800080"/></label>
          <!--end panel skop --> 
          </div>
          </div>
          </div>
          ...
          <div align="right">
            		<button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('pnpa/treeview_pnpa/'.$this->uri->segment(3)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
