<!--breadcrumb-->
   ...
   <div class="clearfix"></div>
    ...
    <?php 
  $form_name = 'pnpa/kawalan_rekod_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'pnpa/kawalan_rekod_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kawalan_rekod_pnpa');
...
?>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <ul class="icomoon-icons-container">
                           <li class="rounded">
                            <span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/pnpa/kemaskinikawalan_rekod/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->pnpa_pata_f8_1d_id; ?>">
                                        </a>
                                    </span></li></ul>
                                </td>
                            </tr>
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                   <a href="<?php echo site_url('pnpa/senarai_ppd_pnpa/'.$this->uri->segment(3))?>"><button class="btn btn-danger input-top-margin" type="button">
                                            Batal</button></a>
                  <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('pnpa/dokumen_rujukan_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
  ...
  <!--/.END tab section-->
    ...
    <!--/.END tab navigation-->
     ...
     <!--popup-->
      <!--  <form id="" class="" action="kawalan_rekod_pnpa/<?php //echo $this->uri->segment(3).'/'.$this->uri->segment(4) ?>" method="post">-->
            ...
            <div class="modal-body">
              <p>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('name' => 'jenis_rekod1', 'value' => set_value('f8_1d_jenis_rekod', $this->session->userdata('f8_1d_jenis_rekod')), 'class' => 'large required')); ?>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('name' => 'lokasi1', 'value' => set_value('f8_1d_lokasi', $this->session->userdata('f8_1d_lokasi')), 'class' => 'large required')); ?>
