                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                       ...
                       <?php $cnt=$this->pnpa_model->get_lkpskopbutiran_count($rr->skop_aktvt_id);
                        ...
                        <td class="hidden-phone"><?php echo $this->pnpa_model->cal_bajet_skop($this->uri->segment(4),$rrq->skop_aktvt_id); ?></td>
                        <td class="hidden-phone"><span class="badge badge-success">Lengkap</span></td>
                        <td class="hidden-phone"><a href="<?php echo site_url()?>/pnpa/skop_aktiviti2_pnpa_edit_ppd/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php  echo $rrq->skop_aktvt_id; ?>">
...
<?php $pnpaID = $this->uri->segment(4); ?>
					<input class="input-large" placeholder="" value="<?php echo $this->pnpa_model->cal_bajet($pnpaID) ?>" readonly/></label>
          ...
          <!--start div button -->
                <div align="right">
                <a href="<?php echo site_url('pnpa/treeview_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
