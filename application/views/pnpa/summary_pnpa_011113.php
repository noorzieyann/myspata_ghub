...
?>						
                        ...
                        <td class="hidden-phone"><a data-original-title="kemaskini" href="#myModal<?php echo $dat->kandungan_id ?>" data-toggle="modal"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a></td>               
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone"><a data-original-title="kemaskini" href="<?php echo site_url('pnpa/model_struktur_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a data-original-title="kemaskini" href="<?php echo site_url('pnpa/treeview_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/edit') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a data-original-title="kemaskini" href="<?php echo site_url('pnpa/kawalan_rekod_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>  
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a data-original-title="kemaskini" href="<?php echo site_url('pnpa/dokumen_rujukan_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">  
                          <span class="badge badge-success">
