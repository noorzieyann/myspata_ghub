    ...
    <!--breadcrumb-->
         <!--start panel Senarai -->
                ...
                <ul class="icomoon-icons-container">
                          <li><a href="<?php echo site_url('pnpa/kandungan_pnpa') ?>" data-toggle="modal">
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <ul class="icomoon-icons-container">
                                    <a href="<?php echo site_url('pnpa/summary_ppd_pnpa_edit')?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                                    </ul>
                                </td>
                            </tr>
                            <?php echo form_close(); ?>
      ...
      $("salinpp").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menyalin kandungan rekod PNPA ID PNPA000001 kepada rekod baru?", function (e) {
          if (e) {
      ...
      $("salinptf").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menyalin kandungan rekod PNPA ID PNPA000002 kepada rekod baru?", function (e) {
          if (e) {
            alertify.success("Anda Klik YA");
          } else {
            alertify.error("Anda Klik Tidak");
      ...
      $("salinppd").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menyalin kandungan rekod PNPA ID PNPA000003 kepada rekod baru?", function (e) {
          if (e) {
            alertify.success("Anda Klik YA");
          } else {
            alertify.error("Anda Klik Tidak");
