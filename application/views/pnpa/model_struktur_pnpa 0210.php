    ...
    <!--END breadcrumb-->
     <br />
      <div class="widget-body">
         ...
         <p><form action='<?php echo site_url(); ?>/pnpa/model_struktur_pnpa' method='post'>
           ...
           <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Model Struktur Penilaian Aset Di Premis
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            ...
                            <tr>
                                <td align="left"><input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name='panel_penilai[]' ></td>
            ...
            <!--start div pelan Komunikasi -->
              ...
              <div class="widget">
                ...
                <div class="widget-body">
               		<div class="control-group">
                     <font color="red"><?php echo form_error('pegawaikaitan'); ?></font> <label>Tugas Dan Pegawai Atasan Yang Ada Kaitan &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="control-group">
                      ...
                      <input class="input-xxlarge" type="text" name="tjawabdankuasa"></label>
                    </div>
                    <div class="control-group">
                      <label>Tugas Pegawai-Pegawai Lain Yang Ada Kaitan&nbsp;
                        <input class="input-xxlarge" type="text" name="pegawailain">
                      </label>
                     </div>
                  </div>
             	</div>
                ...
                <div class="modal-header">
                      ...
                      <!--start div modal body -->
                       <div class="modal-body">
                             <input type='text' value='<?php echo $this->uri->segment(3); ?>' name='no' >
