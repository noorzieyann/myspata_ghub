                ...
                <ul class="icomoon-icons-container">
                  ...
                  <?php } ?>
                      ...
                      <tbody>
                           ...
                           if ($sessionarray ['user_rolegroupid'] != 8 && $get_status == 'Deraf'){}else { ?>
                            ...
                            <tr>
                                ...
                                <td>
									<a href="#myModal<?php echo $rec->pnpa_id ?>" data-toggle="modal" data-original-title="Klik disini bagi memaparkan sejarah status" data-placement="top">
                    ...
                    else if($sessionarray ['user_rolegroupid'] == 8)
                    {
                      ?><ul class="icomoon-icons-container">
						<?php if(($rec->tahun==0)&& $rec->nama_premis=='' && $rec->nodpa=='' ){ ?>
								<a href="<?php echo site_url('pnpa/kandungan_pnpa_copy/'.$this->uri->segment(3).'/'.$rec->pnpa_id)?>">
								<li class="rounded">
								  <span class="fs1" data-icon="&#xe026" aria-hidden="true">
								  </span>
								</li>
							  ...
							  <?php
									...
									*/
									...
									//if($get_status == 'Lulus')
									{
										...
										?>
										<a href="#copy<?php echo $countCopy;?>" title="Salin rekod ini?"  data-toggle="modal" id="<?php echo $rec->pnpa_id;?>"  >
											<li class="rounded">
										...
										<?php
											...
											echo '<a href="'.site_url('pnpa/copyborang/'.$this->uri->segment(3).'/'.$rec->pnpa_id).'">'.form_button($lulus)."</a>";
 ...
 <?php if(!empty($senarai_pnpa)) : foreach ($senarai_pnpa as $rec) :?>
  <div id="myModal<?php echo $rec->pnpa_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                 ...
                 <?php endforeach; ?>
                   <?php endif; ?>
<!-- end modal -->
<div id="copy" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-header">
 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> ×</button>
 <h4 id="myModalLabel">Mesej Pengesahan</h4></div>
 <div class="modal-body"><p>Adakah anda ingin membuat salinan? </p></div>
