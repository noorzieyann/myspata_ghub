...
$kand_utama = array(
	...
	'kand_utama[3]'=>'Skop dan Aktiviti Ppun',
...
if($this->uri->segment(4) != NULL){
	foreach($this->pnpa_model->get_pnpa_from_segment($this->uri->segment(4)) as $row){
...
?>  
    ...
    <br /> 
    <?php 
	$form_name = 'pnpa/kandungan_pnpa/'.$this->uri->segment(3);
	if($this->uri->segment(4) != NULL){$form_name = 'pnpa/kandungan_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4);}
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                  ...
                  <div class="control-group">
					  ...
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Struktur organisasi dan pelan komunikasi perlu disediakan bagi menerangkan organisasi pelaksanaan penerimaan aset (Sebagaimana JKR.PATA.F8/1a)." data-icon="&#xe0f7;"></a>
                      </label>    
                    <div class="wysiwyg-container">
                        <?php
                                $carta = $kand_detail[2];
                  ...
                  <div class="control-group">
					  ...
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="PTF perlu menentukan/ menetapkan keperluan teknikal, proses, tempoh pelaksanaan, keperluan sumber, tanggungjawab dan kuasa pegawai yang terlibat bagi aktiviti berikut: (Sebagaimana JKR.PATA.F8/1b)" data-icon="&#xe0f7;"></a>
                  ...
                  <div class="control-group">
					  ...
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="PTF hendaklah menyediakan Analisis Keperluan Sumber Aktiviti Penerimaan Aset bagi tujuan permohonan peruntukan (Sebagaimana JKR.PATA.F8/1c)." data-icon="&#xe0f7;"></a>
                  ...
                  <div class="control-group">
                      ...
                      <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Kawalan rekod penilaian aset sebagaimana JKR.PATA.F8/1d." data-icon="&#xe0f7;"></a>
                     </label>
                    <div class="wysiwyg-container">
                        <?php
                  ...
                  <div class="control-group">
                      ...
                      <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Sebarang dokumen yang dirujuk dalam penyediaan PNPA sebagaimana JKR.PATA.F8/1e." data-icon="&#xe0f7;"></a>
                     </label>
                    <div class="wysiwyg-container">
                        <?php
