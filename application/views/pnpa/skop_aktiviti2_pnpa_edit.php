		...
		<div class="span12">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="input-xxlarge" type="text" disabled placeholder="Butiran Aktiviti 1">
                      </div></div>
		...
		<div class="span12">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="input-xxlarge" type="text"  placeholder="pihak berkaitan yang terlibat">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                     ...
                     style="height: 100px; width: 550px"  placeholder="pegawai berkenaan"></textarea>
                  </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="input-append">
                       <input type="text" name="date_range1" id="date_range1" class="span8 date_picker" placeholder="22/12/12"/>
                      ...
                      Hingga
 <div class="input-append">
   <input type="text" name="report_range1" id="report_range1" class="span8 report_range" placeholder="21/12/13"/>
   <span class="add-on">
                      <i class="icon-calendar"></i>
                      </span></label>
                      ...
                      <div class="controls">
                       <textarea name="textarea" class="input-block-level" 
                     style="height: 100px; width: 550px"  placeholder="Sila ambik perhatian"></textarea>
			...
			<select id="subject">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="input-large" type="text"  placeholder="80000800080"></div>
                    </div>
                    ...
                    <div class="controls">
                      ...
                      <div class="controls">
                       <textarea name="textarea" class="input-block-level" 
                     style="height: 100px; width: 550px" placeholder="Bagus!"></textarea>
                      </div></div>
            ...
            <div class="span12">
              ...
              <!-- start rancang -->
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                      ...
                      <label class="checkbox"><input type="checkbox" value=""  checked="checked" >Mohd Adib bin Baharuddin</label>
             ...
             <div class="span4">
               ...
               <a href="<?php echo site_url('pnpa/summary_ptf_pnpa_edit') ?>"> <button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa_edit') ?>"><button class="btn btn-warning2 input-top-margin" type="button">
                        Simpan
                      </button></a>
                      </form>
             </div><!--end div button -->
