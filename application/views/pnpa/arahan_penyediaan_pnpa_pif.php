            ...
            <div class="span12">
             ...
             <table>  <tr><td>
              ...
              <?php 
                ...
                $pif='pif';
              echo form_dropdown('pegawai', $options, $pif); ?>
             </td><td width="20%"></td>
             <td>   
            ...
            <div class="span12">
              ...
              <div class="widget-body">
               <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'arahan_penyediaan_pnpa_pif',
                           'id' => 'arahan_penyediaan_pnpa_pif',
                        );
                    echo form_open('pnpa/arahan_penyediaan_pnpa_pif/'.$this->uri->segment(3),$attributes); ?>
               ...
               <div id="dt_example" class="example_alt_pagination">   
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Pegawai Inspektorat Fasiliti</td>
                        <td><?php
                              $data = array(
                              'name'        => 'userid[]',
                              'id'          => 'userid[]',
                  ...
                  <tr>
                      ...
                      <?php if($this->pnpa_model->get_pelan_ptra($this->uri->segment(3),1)==FALSE)
                        ...
                        ?>     <label class="checkbox">
                              <?php echo form_checkbox('ptra', '1'); ?></label>
                       <?php  }else 
                       ...
                       ?>      <label class="checkbox">
                        ...
                        ?>     <label class="checkbox">
                              <?php echo form_checkbox('popa', '1'); ?></label>
                       <?php  }else 
                       ...
                       <?php if($this->pnpa_model->get_pelan_pnpa($this->uri->segment(3),1)==FALSE)
                        ...
                        ?>     <label class="checkbox">
                              <?php echo form_checkbox('pnpa', '1'); ?></label>
                       <?php  }else 
                       ...
                       <?php if($this->pnpa_model->get_pelan_ppun($this->uri->segment(3),1)==FALSE)
                        ...
                        ?>     <label class="checkbox">
                              <?php echo form_checkbox('ppun', '1'); ?></label>
                       <?php  }else 
                       ...
                       ?>      <label class="checkbox">
                        ...
                        ?>     <label class="checkbox">
                              <?php echo form_checkbox('pla', '1'); ?></label>
                       <?php  }else 
