...
?>  
    ...
    <br /> 
    <?php 
	$form_name = 'pnpa/kandungan_pnpa_copy/'.$this->uri->segment(3);
	if($this->uri->segment(4) != NULL){$form_name = 'pnpa/kandungan_pnpa_copy/'.$this->uri->segment(3).'/'.$this->uri->segment(4);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kandungan_pnpa_copy');
