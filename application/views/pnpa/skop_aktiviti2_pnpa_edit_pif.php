		...
		<div class="span12">
 		...
 		<div class="span3">
                ...
                <div class="widget-body">
                    ...
                    <!--start div button -->
                <div align="right">
                <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa_edit_pif/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Kembali
                  </button></a>
   		   </div>
                <!--end div button -->
