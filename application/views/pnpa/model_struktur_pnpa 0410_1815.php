     ...
     <br />
      <div class="widget-body">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                     ...
                     <label>Tanggungjawab Dan Kuasa Yang Diberikan &nbsp;&nbsp;&nbsp;&nbsp;
                      <?php
                       ...
                       ?> 
                    <?php echo form_input(array('name' => 'tjawabdankuasa', 'value' => $tjawabdankuasa, 'class' => 'xxlarge')); ?>
                     </label>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <label>Tugas Pegawai-Pegawai Lain Yang Ada Kaitan&nbsp;
                       ...
                       ?> 
                      <?php echo form_input(array('name' => 'pegawailain', 'value' => $pegawaikaitan, 'class' => 'xxlarge')); ?>
                      </label>
                     </div>
                  </div>
             	</div>
         ...
         <!-- popup tambah panel penilai teknikal -->
          ...
          <form id="" class="" action="<?php echo base_url(); ?>pnpa/tambahpanel" method="post"> 
