  ...
  <div class="tab-content" id="myTabContent">
    <div id="home" class="tab-pane fade active in">
      ...
      <div class="main-container">
        ...
        <!--popup-->
        <form id="" class="" action="dokumen_rujukan_pnpa" method="post" enctype="multipart/form-data" >
        ...
        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <div class="modal-body">
              <p> <input type='hidden' value='<?php echo $this->uri->segment(3); ?>' name='no' >
                    ...
                    <!--<div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('name' => 'nama_fail2', 'value' => set_value('nama_fail', $this->session->userdata('nama_fail')), 'class' => 'large required')); ?>
                      <font color="red"><?php echo form_error('nama_fail'); ?></font>
                      </div>
                    </div>
                    <div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('type' => 'file', 'name' => 'nama_fail_asal2', 'value' => set_value('nama_fail_asal', $this->session->userdata('nama_fail_asal')), 'class' => 'large required')); ?>
                      <font color="red"><?php echo form_error('nama_fail_asal1'); ?></font>
                    </div>
                    </div>
                    <div class="control-group">
        ...
        <!--/.END popup-->
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <ul class="icomoon-icons-container">
                                    <a href="<?php //echo site_url('pnpa/summary_pp_pnpa_editpp')?>"><li class="rounded"><span class="fs1" data-icon="&#xe0a7" aria-hidden="true" id="hapus1"></span></li></a>
                                    </ul>
                                </td>
                            </tr>
                            <?php echo form_close(); ?>
          ...
          <!--END panel 2-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('pnpa/kawalan_rekod_pnpa/'.$this->uri->segment(3))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('pnpa/summary_pnpa/'.$this->uri->segment(3))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
                </div> 
                <!--/.END buttons--> 
