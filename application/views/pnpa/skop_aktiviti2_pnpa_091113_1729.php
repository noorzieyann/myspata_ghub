...
<div class="widget-body">
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='pnpa/skop_aktiviti2_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
    ...
    <?php echo validation_errors(); ?>
         ...
         <p>
              <?php /*
                    ...
                    echo form_open('pnpa/skop_aktiviti2_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),$attributes); */ ?>
            ...
            <div class="span12">
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb=0; ?>
                        ...
                        <?php 	
							if($this->pnpa_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5))== FALSE)
							{ 
								echo ''; 
								?>    
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb2=0; ?>
                       ...
                       <?php 
								...
								if($this->pnpa_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),1)== FALSE)
								{
									$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
                                }
                                else 
             ...
             <div class="span4">
                ...
                <button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
