...
<div class="widget-body">
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='pnpa/skop_aktiviti2_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
	if($this->uri->segment(5) != NULL){$form_name = 'pnpa/skop_aktiviti2_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_pnpa_edit_ppd');
              ...
              <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'skop_aktiviti2_pnpa_edit_ppd',
                           'id' => 'skop_aktiviti2_pnpa_edit_ppd',
                        );
                    echo form_open('pnpa/skop_aktiviti2_pnpa_edit_ppd/'.$this->uri->segment(4).'/'.$this->uri->segment(5),$attributes); ?>
    ...
    <!-- start rancang -->
                ...
                <div class="widget-body">
					...
					<?php // mymodal rancang begin here ?>
						...
						<div class="modal-body">
						  ...
						  <label class="radio"><input type="radio" name="kosflag<?php echo $count; ?>" id="optionsRadios" value="2">Gaji dan Kos Lebih Masa</label>
						   ...
						   <input type="hidden" name="pnpa_id" value="<?php echo $this->uri->segment(4)?>">
                    ...
                    <?php  
                            ...
                            {
								$runQuery = $this->pnpa_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5));
								foreach ($runQuery as $rQ){$idExisting = $rQ->pnpa_pata_f8_1b1c_sumber_man_id; }
                    ...
                    ?>      	<input type="hidden" value="<?php echo $idExisting; ?>" name="txtrancang_sumberget" id="txtrancang_sumberget<?php echo $count; ?>"  />
								<label class="checkbox">
									...
									<?php echo $rec->nama; ?>
									<?php 	
										if($this->pnpa_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),1)== FALSE)
										{
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $count=0; ?>
                        ...
                        <?php 
							if($this->pnpa_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5))== FALSE)
                            { 
                        ?>     
							<label class="checkbox">
                        ...
                        <?php  
                            ...
                            {
								$runQuery = $this->pnpa_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5));
								foreach ($runQuery as $rQ){$idExisting = $rQ->pnpa_pata_f8_1b1c_sumber_man_id; }		
                        ?>    
							...
							<label class="checkbox">
                               <input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModaly<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="accepted" checked>
								<?php echo $rec->nama; ?>
								<?php 	if($this->pnpa_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),1)== FALSE)
										{
											$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
										}
										else 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                        ...
                        <?php  	}
								...
								{
									$runQuery = $this->pnpa_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5));
									foreach ($runQuery as $rQ){$idExisting = $rQ->pnpa_pata_f8_1b1c_sumber_man_id; }
                        ?>      
									...
									<label class="checkbox">
									   <input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModal3<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="proceed"  checked>
										<?php 	echo $rec->nama; ?>
										<?php 	if($this->pnpa_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5),1)== FALSE)
												{
													$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
												}
												else { $total= $total + $rec->gaji; }
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calVal = 0; $count=1; if(!empty($senarai_alat_pej)) : foreach ($senarai_alat_pej as $rec1) : ?>
									...
									<?php if($checkPjbt = $this->pnpa_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec1->urus_pej_id,$rec1->kat_alat_pej_id)) { echo "checked"; } 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calValFax=0; $autoNumb=1; if(!empty($senarai_fax)) : foreach ($senarai_fax as $rec2) : ?>
							...
							<?php if($checkPjbt = $this->pnpa_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec2->urus_pej_id,$rec2->kat_alat_pej_id)) { echo "checked"; } 
                ...
                <div class="widget-body">
                  ...
                  <label class="checkbox">
                         ...
                         <label class="checkbox">
							  ...
							  <?php if($checkPjbt = $this->pnpa_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec3->urus_pej_id,$rec3->kat_alat_pej_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKom=0; $count=1; if(!empty($senarai_kom)) : foreach ($senarai_kom as $rec4) : ?>
                          <label class="checkbox">
							 ...
							 class="machKom" 
							 <?php if($checkAlat = $this->pnpa_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec4->alat_kerja_id,$rec4->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValPeriksa=0; $count=1; if(!empty($senarai_pemeriksa)) : foreach ($senarai_pemeriksa as $rec7) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->pnpa_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec7->alat_kerja_id,$rec7->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKend=0; $count=1; if(!empty($senarai_kenderaan)) : foreach ($senarai_kenderaan as $rec5) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->pnpa_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec5->alat_kerja_id,$rec5->kat_alat_kerja_id)) { echo "checked"; } 
	...
	<!-- start PPE -->
 		<div class="span3">
                ...
                <div class="widget-body">
                         ...
                         <?php $calValPPE=0; $count=1; if(!empty($senarai_ppe)) : foreach ($senarai_ppe as $rec6) : ?>
                            ...
                            <label class="checkbox">
                             <input id="ppe<?php echo $count; ?>" type="checkbox" value="<?php echo $rec6->alat_kerja_id; ?>cb<?php echo $rec6->kos_seunit; ?>" name="ppe[]"
							  ...
							  <?php if($checkAlat = $this->pnpa_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec6->alat_kerja_id,$rec6->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <!--start div button -->
                <div align="right">
                <a href="<?php echo site_url('pnpa/skop_aktiviti_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Kembali
                  </button></a>
                     <!--<a href="<?php echo site_url('pnpa/summary_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-warning2 input-top-margin" type="button">                       Simpan
                      </button></a>-->
...
$(document).ready(function(){ 
	$('.planning').click(function(){
		...
		{ 
			...
			$.ajax({
                type: "POST",
                url: "<?php echo site_url(); ?>/pnpa/set_skop_aktiviti_pnpa/"+jgk, 
