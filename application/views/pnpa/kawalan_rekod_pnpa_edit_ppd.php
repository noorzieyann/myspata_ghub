...
<?php if(!empty($tab)) { echo $tab;} ?>
    <?php 
  $form_name = 'pnpa/kawalan_rekod_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'pnpa/kawalan_rekod_pnpa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kawalan_rekod_pnpa_edit_ppd');
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <ul class="icomoon-icons-container">
                           <li class="rounded">
                            <span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/pnpa/kemaskinikawalan_rekod_ppd/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->pnpa_pata_f8_1d_id; ?>">
                                        </a>
                                    </span></li></ul>
                                </td>
                            </tr>
