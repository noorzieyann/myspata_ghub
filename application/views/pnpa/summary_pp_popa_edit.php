...
<!-- breadcrumb END -->
    ...
    <div class="widget-body">
                  <ul class="nav nav-tabs no-margin myTabBeauty">
                    ...
                    <li class="">
                      <a href="<?php echo site_url('ptra/senarai_ptf_ptra')?>" data-original-title="">PTRA
                      </a>
                    </li>
                    <li class="active">
                      <a data-toggle="tab" href="<?php echo site_url('popa/senarai_ppd_popa')?>" data-original-title="">
                        POPA
                      </a>
                    </li>
                    <li class="">
                      <a data-toggle="tab" href="<?php echo site_url('pnpa/senarai_ppd_pnpa')?>" data-original-title="">
                        PNPA
                      </a>
                    </li>
                    <li class="">
                      <a data-toggle="tab" href="<?php echo site_url('ppun/senarai_ppun')?>" data-original-title="">
                        PPUN
                      </a>
                    </li>
                    <li class="">
                      <a data-toggle="tab" href="<?php echo site_url('pla/senarai_ppd_pla')?>" data-original-title="">
                        PLA
                      </a>
                    </li>
                  </ul>
  ...
  <div class="tab-content" id="myTabContent">
                ...
                <div class="widget-body">
                  <form class="form-horizontal no-margin">
                      ...
                      <div class="control-group">
                        ...
                        <input class="input-large" type="text" placeholder="2010" name="tahun" id="tahun">
                      </div>
                    </div>
    ...
    <!--/.END popup pendahuluan-->
                      ...
                      <tr>
                        ...
                        <li class="rounded"><a href="#objektif"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                      </td>             
                        <td class="hidden-phone">
                          <span class="badge badge-success">
		...
		<!--/.END popup objektif-->
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="#carta"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
		...
		<!--/.END popup carta-->
                      ...
                      <tr>
                        <td>
                          <span class="name">
                            4.0</span></td>
                        <td class="hidden-phone">Skop dan Aktiviti Operasi dan Penyenggaraan Aset</td>
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="#skop"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
            ...
            <div class="modal-body">
              <p>
				<form class="form-horizontal no-margin">
                  ...
                  <div class="control-group">
                      <label>
                        4.0 Skop dan Aktiviti Operasi dan Penyenggaraan Aset
                      </label>                  
                  <div class="wysiwyg-container">
		...
		<!--/.END popup skop-->
                      ...
                      <tr>
                        <td>
                          <span class="name">
                            5.0</span></td>
                        <td class="hidden-phone">Penyediaan Keperluan Sumber Aktiviti Operasi dan Penyenggaraan Aset</td>
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="#sedia"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
            ...
            <div class="modal-body">
              <p>
				<form class="form-horizontal no-margin">
                  ...
                  <div class="control-group">
                      <label>
                        5.0 Penyediaan Keperluan Sumber Aktiviti Operasi dan Penyenggaraan Aset 
                      </label>                  
                  <div class="wysiwyg-container">
		...
		<!--/.END popup penyediaan-->
                      ...
                      <tr>
                        <td>
                          <span class="name">
                            6.0</span></td>
                        <td class="hidden-phone">Kawalan Rekod Operasi dan Penyenggaraan Aset</td>
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="#kawal"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
            ...
            <div class="modal-body">
              <p>
				<form class="form-horizontal no-margin">
                  ...
                  <div class="control-group">
                      <label>
                        6.0 Kawalan Rekod Operasi dan Penyenggaraan Aset
                      </label>                  
                  <div class="wysiwyg-container">
		...
		<!--/.END popup kawalan-->
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="#rujukan"  data-toggle="modal">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded"><a href="<?php echo site_url('popa/model_struktur_popa_edit')?>">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/treeviewskop_popa_edit_pp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/kawalan_rekod_popa_edit_pp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit_pp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
        ...
        <!--panel 4-->  
         ...
         <!--/.END panel 4-->
                ...
                <div class="widget-body" align="right">
                 ...
                 <button class="btn btn-info input-top-margin" type="button">
                    Pembetulan
                  </button>
