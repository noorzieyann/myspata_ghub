                            ...
                            echo ''. validation_errors('<div class="mws-form-message error">','</div>') . '';
                              ...
                              if($this->session->flashdata('flashError'))
                                ...
                                ?>             
                                    ...
                                    <form id="" class="" action="<?php echo site_url() ?>/pnpa/kemaskinipanel_penilai_pnpa_ppd2/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5) ?>" method="post">
