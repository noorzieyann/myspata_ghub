            ...
            <tbody>
              ...
              <?php echo form_open('admin/update'); ?>
                ...
                <tr>
                  ...
                  <td>
                    <?php if($getstatus = $this->penyelarasan_akt_model->get_stat_list($rec->status_id))
                  ...
                  <td align="center">
                                    ...
                                    <a href="<?php echo site_url('penyelarasan_akt/penyelarasan_akt_pp')?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                                    </ul>
                                </td>
                </tr>
