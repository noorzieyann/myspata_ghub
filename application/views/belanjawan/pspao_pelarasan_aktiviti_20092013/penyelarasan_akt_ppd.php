<!-- page: penyelarasan aktiviti ppd, by seri, 18092013 -->


<?php 
  $attributes = array(
                      'class' => 'form-horizontal no-margin', 
                      'name'  => 'penyelarasan_akt_ppd',
                      'id'    => 'penyelarasan_akt_ppd',
                     );

                echo form_open('penyelarasan_akt/penyelarasan_akt_ppd',$attributes); 
?>
                 


<!-- panel maklumat pspao START -->
<div class="row-fluid">
  <div class="span12">
    <div class="widget">
            ...
            <table class="table table-condensed table-striped table-bordered table-hover no-margin">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="hidden-phone">
                    <input class="input-small" type="text"  name="" id=""/>
                  </td>
                  <td class="hidden-phone">
                    90
                  </td>
...
<div class="next-prev-btn-container ">
  <div class="widget-body" align="right">
    ...
    <a class="btn btn-success input-top-margin" href="<?php echo site_url('penyelarasan_akt/senarai_penyelarasan_akt') ?>" id="confirm">
      Hantar
    </a>
    <a href="<?php echo site_url('penyelarasan_akt/senarai_penyelarasan_akt')?>">
 ...
 <?php  echo form_close();?>
   ...
   <script type="text/javascript">
      ...
      $("lulus").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin meluluskan permohohan pengagihan belanjawan?", function (e) {
          if (e) {
