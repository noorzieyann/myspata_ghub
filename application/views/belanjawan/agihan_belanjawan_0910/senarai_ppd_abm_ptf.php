        ...
        <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'senarai_ppd_abm_ptf',
                           'id' => 'senarai_ppd_abm_ptf',
                        );
        echo form_open('belanjawan/agihan_belanjawan/senarai_ppd_abm_ptf',$attributes); ?>
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Senarai Pegawai Penyedia Dokumen (PPD)
                  </div>
                </div>
       ...
       $("hantar").onclick = function () {
        ...
        alertify.confirm("Adakah anda pasti untuk hantar?", function (e) {
          if (e) {
            ...
            window.location ="<?php echo site_url('belanjawan/senarai_ppd_abm_ptf') ?>";
