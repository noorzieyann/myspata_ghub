...
<?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'agihan_belanjawan_ptf_sah',
                           'id' => 'agihan_belanjawan_ptf_sah',
                        );
                    echo form_open('belanjawan/agihan_belanjawan/agihan_belanjawan_ptf_sah',$attributes); ?>
...
<!-- ALERT -->
    <script type="text/javascript">
      ...
      $("sah").onclick = function () {
        reset();
        alertify.confirm("Adakah anda pasti untuk sah?", function (e) {
          if (e) {
