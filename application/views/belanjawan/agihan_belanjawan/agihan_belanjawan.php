...
<!--main container-->
      <div class="main-container">
        ...
        echo form_open('belanjawan/agihan_belanjawan/agihan_belanjawan',$attributes); ?>
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  <div id="dt_example" class="example_alt_pagination">
                    ...
                    {
                      echo ''?><ul class="icomoon-icons-container">
                                    <a href="<?php echo site_url('belanjawan/agihan_belanjawan_ptf')?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                                    </ul>
                    <?php ; } 
                    ...
                    {
                      echo ''?><ul class="icomoon-icons-container">
                                    <a href="<?php echo site_url('belanjawan/agihan_belanjawan_ppd')?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                                    </ul>
                    <?php ; } 
