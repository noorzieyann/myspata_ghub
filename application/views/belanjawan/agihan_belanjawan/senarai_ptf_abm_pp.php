                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($get_kem = $this->agihan_model->get_namakem($rec->idkem)) foreach ($get_kem as $rr) echo $rr->namakem;?></td>
                                <td><?php if($get_jab_agensi = $this->agihan_model->get_namajab_agensi($rec->idjab_agensi)) foreach ($get_jab_agensi as $rr) echo $rr->nama_jab_agensi;?></td>
                            </tr>
                            <?php //echo form_close(); ?>
                            <?php endforeach; ?>
                            <?php endif; ?>
          ...
          <!--END panel 2-->
                ...
                <div class="widget-body" align="right">
                  <!--a class="btn btn-success input-top-margin" href="#" id="hantar">
                    ...
                    <input type="submit" nam="btnSubmit" value="Hantar" id="hantar" class="btn btn-success input-top-margin" />
                </div> 
                <!--/.END buttons--> 
      </div>  
      <!--/.END main-container-->  
