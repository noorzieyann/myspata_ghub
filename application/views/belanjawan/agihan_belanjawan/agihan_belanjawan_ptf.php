...
<div class="main-container">
    ...
    echo form_open('belanjawan/senarai_ppd_abm_ptf', $attributes);
    ?>
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-large" type="text" placeholder="100,000.00" readonly="readonly" value="<?php echo($jum_kos_mohon);?>" name="txt_mohon" disabled>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-large" type="text" name="txt_terima"  placeholder="85,000.00" disabled> 
                        </div>
    ...
    <div class="widget-body" align="right">
        <!--a href="<?php echo site_url('belanjawan/senarai_ppd_abm_ptf') ?>"><button class="btn btn-primary input-top-margin" type="button">
                Seterusnya test
            </button></a-->
