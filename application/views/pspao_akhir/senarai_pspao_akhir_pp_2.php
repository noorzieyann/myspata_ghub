...
?>						
                      <tr>
                        ...
                        <a href="<?php echo site_url('pspao/pspao_akhir_pp_f1/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f2'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_pp_f2/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f3'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_pp_f3/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f4'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_pp_f4/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f5'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_pp_f5/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php } ?>
