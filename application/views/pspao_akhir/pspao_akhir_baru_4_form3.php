...
echo form_open('pspao/pspao_akhir_baru_4_form3/'.$this->uri->segment(3).'/'.$this->uri->segment(4),$attributes);
?>
            ...
            <div class="span12">
              <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div class="wysiwyg-container"><textarea id="nowucme" name ="kand_detail" class="input-block-level" style="height: 80px"><?php echo $kandungan ?></textarea></div>
