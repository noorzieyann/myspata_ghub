...
echo form_open('pspao/senarai_pspao_akhir_ptf_2/'.$this->uri->segment(3),$attributes);
?>
...
?>                  
                  	<?php echo form_input('tahun_mula',$tahun_mula,'class="span5 input-left-top-margins" readonly="readonly"'); ?>
...
?>                  
                      <?php echo form_input('tahun_akhir',$tahun_akhir,'class="span5 input-left-top-margins" readonly="readonly"'); ?>
...
?>						
                      <tr>
                        ...
                        <a href="<?php echo site_url('pspao/pspao_akhir_ptf_f1/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f2'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_ptf_f2/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f3'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_ptf_f3/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f4'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_ptf_f4/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f5'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_ptf_f5/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php } ?>
...
<?php } ?>
         <!--/.END panel 4-->
             ...
             <div class="next-prev-btn-container pull-right">
                ...
                <a type="button" class="btn btn-info" href="#hantar" data-toggle="modal">Sah</a>
                <?php } ?>
             </div>
...
<div class="modal-body"><p>Adakah anda ingin meluluskan PSPA(O) Akhir ini?</p></div>
	...
	<?php
		...
		echo form_button($batal);
		echo form_submit('hantar', 'Sah','class="btn btn-info"');
	?>
