...
echo form_open('pspao/pspao_akhir_baru_4/'.$this->uri->segment(3),$attributes);
?>
...
?>						
                      <tr>
                        ...
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_4_form1/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f2'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_4_form2/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f3'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_4_form3/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f4'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_4_form4/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php if($dat->kand_form == 'f5'){ ?>
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_4_form5/'.$this->uri->segment(3).'/'.$dat->kandungan_id) ?>"><ul class="icomoon-icons-container"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe025;"></span></li></ul></a>
                        <?php } ?>
                        <?php } ?>
                        </td>               
                        <td class="hidden-phone">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <a href="<?php echo site_url('pspao/pspao_akhir_baru_5/'.$this->uri->segment(3)) ?>">
                        <li class="rounded">
