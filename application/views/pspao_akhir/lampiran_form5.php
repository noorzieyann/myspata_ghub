                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="confirmation" href="<?php echo site_url('pspao/hapus_pspao_akhir_lampiran_form5/'.$rec->lampiran_id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>"><li class="rounded"><span class="fs1" data-icon="&#xe0a7" aria-hidden="true" id="hapus1" ></span></li></a>                                    
                                    </ul>
                                </td>
                                <?php } ?>
                            </tr>
