...
<?php 
	$form_name = 'pspao/arahan_sedia_pspao_akhir_ptf';
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'arahan_sedia_pspao_akhir_ptf');
	echo form_open($form_name, $attributes);
?>
              
                   <div class="widget">
                     <div class="widget-header">
                      <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span>Penerimaan Arahan Penyediaan PSPA(O) Akhir (Kepada PTF)</div>
                     </div>
                ...
                <input name="Hantar" type="submit" value="Hantar" class="btn btn-success" />
