...
<div class="row-fluid">
              ...
              <div class="widget">
                ...
                <?php echo validation_errors(); ?>
                 ...
                 <?php 
                    ...
                    echo form_open('pspao_awal/arahan_sedia_pspao_ptf/'.$this->uri->segment(3),$attributes); 
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Sila Pilih Pegawai Teknikal Fasiliti di Bawah Bagi Penyediaan PSPA(O) Awal
                  </div>
                </div>
               ...
               <div id="dt_example" class="example_alt_pagination">   
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Pegawai Teknikal Fasiliti</td>
                        <td><?php
                              $data = array(
                              'name'        => 'userid[]',
                              'id'          => 'userid[]',
