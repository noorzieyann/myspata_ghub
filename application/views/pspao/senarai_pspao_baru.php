                   ...
                   <ul class="icomoon-icons-container">
                      <?php
                           ...
                           if(($mu[2]['menu_cipta[2]'])==1){ 
                            ...
                            if(!empty($pspao_awal_id)){
                           ?>

                         <a href="<?php echo site_url('pspao_awal/pspao_baru') ?>"><li>
                   ...
                   <div id="dt_example" class="example_alt_pagination">   
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:20%">Pemilik Dokumen</th>
                        <th style="width:10%">Tarikh Sedia</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <?php  
                        if($get_kemname = $this->pspao_model->get_kementerian_name($rec->idkem)) 
                        
                          echo $get_kemname; 

                          ?></td>
                        <td><?php if($get_namapemilikdoc = $this->pspao_model->get_nama_pemilik_doc($rec->pspa_sedia_oleh_id)) 
                         foreach ($get_namapemilikdoc as $row) 
                          echo $row->nama_user;  ?></td>

                        <td><?php echo $rec->pspa_tarikh_sedia; ?></td>

                        <td><a href="#myModal<?php echo $rec->pspa_awal_id ?>" data-toggle="modal" data-original-title="Klik disini bagi memaparkan sejarah status" data-placement="top">
                        ...
                        <td>
                          ...
                          <a href="<?php echo site_url('pspao_awal/ulasan_ptf_sah_pspao/'.$rec->pspa_awal_id) ?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                          ...
                          <a href="<?php echo site_url('pspao_awal/ulasan_pp_lulus_pspao/'.$rec->pspa_awal_id) ?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                          
                          <?php
                          }else if(($mu[2]['menu_kemaskini[2]'])==1){ ?>

                           <a href="<?php echo site_url('pspao_awal/ulasan_ppd_pspao/'.$rec->pspa_awal_id) ?>"><li class="rounded"><span class="fs1" data-icon="&#xe026" aria-hidden="true"></span></li></a>
                         ...
                         <a href="<?php echo site_url('pspao_awal/pspao_baru_copy/'.$rec->pspa_awal_id) ?>"> <li class="rounded"><span class="fs1" data-icon="&#xe027" aria-hidden="true"></span></li></a>
...
<!--start model sejarah status -->
 <?php if(!empty($result)) : foreach ($result as $rec) : ?>
  <div id="myModal<?php echo $rec->pspa_awal_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <table class="table table-condensed table-striped table-hover table-bordered pull-left">
                            ...
                            <?php  $i=1; if($getSts = $this->pspao_model->get_senarai_status($rec->pspa_awal_id,1))  :foreach ($getSts as $rr) :?>
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $rr->nama_status; ?></td>
                                <td><?php echo $rr->status_tarikh; ?></td>
                                <td><?php if($getSta = $this->pspao_model->get_namakategoristatus($rr->kump_kand_id))  :foreach ($getSta as $rq): ?><?php echo $rq->kump_kand_kod; ?><?php endforeach; ?>
                             <?php endif; ?></td>
