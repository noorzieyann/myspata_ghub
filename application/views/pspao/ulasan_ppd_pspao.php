                 ...
                 <div id="pspao" class="tab-pane fade active in">
                   ...
                   <?php 
                       $attributes = array(
                           ...
                           'name'  => 'ulasan_ppd_pspao',
                           'id'    => 'ulasan_ppd_pspao',
                        );
                    echo form_open('pspao_awal/ulasan_ppd_pspao/'.$this->uri->segment(3),$attributes); ?>
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <div class="widget-body">
                    ...
                    ?> 
           <?php echo form_dropdown('tempoh_mula', $year_list,$tahun_mula,'disabled="disabled"', 'id="tempoh_mula"',
     ...
     <a id="popoverOption" href="#"  
           ...
           data-placement="right" data-icon="&#xe0f7;"></span-->
                    ...
                    <div class="wysiwyg-container">
                        <?php echo form_error('kand_detail'); ?>
                    <?php 
                          $data = array(
                                    'name'        => 'kand_detail[]',
