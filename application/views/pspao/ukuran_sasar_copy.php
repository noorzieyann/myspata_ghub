                ...
                <?php //echo validation_errors(); ?>
                      ...
                      <?php 
                       $attributes = array(
                           ...
                           'name'  => 'ukuran_sasar_copy',
                           'id'    => 'ukuran_sasar_copy',
                        );
                    echo form_open('pspao_awal/ukuran_sasar_copy/'.$this->uri->segment(3),$attributes); ?>
...
<a href="<?php echo site_url('pspao_awal/pspao_baru_copy/'.$this->uri->segment(3)) ?>"> 
          <?php
        $sebelum = array(
            'name'    => 'sebelum',
            'id'      => 'sebelum',
