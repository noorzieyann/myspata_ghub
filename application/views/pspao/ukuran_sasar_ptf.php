...
<?php } ?>
                ...
                <?php //echo validation_errors(); ?>
                      ...
                      <?php 
                       $attributes = array(
                           ...
                           'name'  => 'ukuran_sasar_ptf',
                           'id'    => 'ukuran_sasar_ptf',
                        );
                    echo form_open('pspao_awal/ukuran_sasar_ptf/'.$this->uri->segment(3),$attributes); ?>
 ...
 <a href="<?php echo site_url('pspao_awal/ulasan_ptf_sah_pspao/'.$this->uri->segment(3)) ?>">
          <?php
        $sebelum = array(
            'name'    => 'sebelum',
            'id'      => 'sebelum',
...
<!-- modal pengesahan sah-->         
 ...
 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> ×</button>
 <h4 id="myModalLabel">Mesej Pengesahan</h4></div>
 <div class="modal-body"><p>Adakah anda ingin mengesahkan PSPA(O) awal ini?</p></div>
 <!--button-->
  <div class="modal-footer">
  <?php
                       $batal = array(
