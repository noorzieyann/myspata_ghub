    ...
    <!--/.END status info-->
      ...
      <div class="main-container">
                    ...
                    <tbody>
                      <tr>
                       ...
                       <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                
        ...
        <!--/.END panel 3-->
               ...
               <a href="<?php echo site_url('main/dokumen_rujukan_pnpa') ?>"><button class="btn btn-primary input-top-margin" type="button">Sebelum</button></a>
