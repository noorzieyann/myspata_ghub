                ...
                <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    <thead>
                      <tr>
                        ...
                        <th width="15%" class="hidden-phone" style="width:15%">Jabatan/Agensi</th>
                        <th width="15%" class="hidden-phone" style="width:15%">Premis</th>
                    ...
                    <tr>
                      ...
                      <tr>
						...
						<td class="hidden-phone"><span class="badge badge-corection">Pembetulan</span></td>
						<td class="hidden-phone">
                         <ul class="icomoon-icons-container">
                      		<a href="index.html"><li class="rounded">
                      		<span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span> </li></a>
