            ...
            <!--start div pelan Komunikasi -->
              ...
              <div class="widget">
                ...
                <button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('main/kandungan_pnpa') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
                      <a href="<?php echo site_url('main/treeview_pnpa') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Seterusnya
                      </button></a> </form>
   		   </div><!--end div button -->
		 <!--end div tab -->
