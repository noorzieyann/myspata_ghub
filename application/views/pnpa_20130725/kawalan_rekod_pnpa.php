               ...
               <div class="widget-body"> 
            	...
            	<div align="right">
            		<button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('main/skop_aktiviti_pnpa') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
                      <a href="<?php echo site_url('main/dokumen_rujukan_pnpa') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Seterusnya
                      </button></a> </form>
           	  </div>
