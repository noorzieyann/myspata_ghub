                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('main/summary_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul>                    
                      </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/summary_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li></ul></td>
                      </tr>
                      <tr>
                        <td>
                          <span class="name">
