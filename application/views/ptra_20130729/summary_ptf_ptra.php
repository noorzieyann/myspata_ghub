              ...
              <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'summary_ptf_ppun',
                           'id' => 'summary_ptf_ppun',
                        );
                    echo form_open('main/summary_ptf_ppun',$attributes); ?>
      	 <!--panel 1-->  
         <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/model_struktur_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/treeview_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/skop_aktiviti_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul> 
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/kawalan_rekod_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>  
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('main/dokumen_rujukan_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>
                        <td class="hidden-phone">  
                          <span class="badge">
                            Deraf
                          </span>
        ...
        <!--panel 4-->  
         ...
         <!--/.END panel 4-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a class="btn btn-info input-top-margin" href="#" id="forever">
                    Pembetulan
                  </a>
                  <a class="btn btn-success" href="#" id="confirm">
                    Sah
                  </a>
                </div>   
                </div>
