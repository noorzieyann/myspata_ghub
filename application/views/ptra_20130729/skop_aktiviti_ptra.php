      ...
      <div class="main-container">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('main/skop_aktiviti2_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                    
                      </td>
                      </tr>
                      <tr>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('main/skop_aktiviti2_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul></td>
                      </tr>
                      <tr>
                        <td rowspan="5">2</td>
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('main/treeview_ptra')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('main/kawalan_rekod_ptra')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
                </div> 
                <!--/.END buttons-->   
