                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('ptra/skop_aktiviti2_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                    
                      </td>
                      </tr>
                      <tr>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('ptra/skop_aktiviti2_ptra')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul></td>
                      </tr>
                      <tr>
                        <td rowspan="5">2</td>
