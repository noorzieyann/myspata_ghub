      ...
      <div class="main-container">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <a href="<?php echo site_url('ptra/skop_aktiviti2_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>                    
                      </td>
                      </tr>
                      <tr>
                        ...
                        <a href="<?php echo site_url('ptra/skop_aktiviti2_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul></td>
                      </tr>
                      <tr>
                        <td rowspan="5">2</td>
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('ptra/treeview_ptra_editppd')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
