          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
               ...
               <div class="widget-body">
                  <ul class="nav nav-tabs no-margin myTabBeauty">
                    <li class=""><a href="<?php echo site_url('ptra/model_struktur_ptra_editptf')?>">Dalaman</a></li>
    ...
    <div id="home" class="tab-pane fade active in">
      ...
      <!--table section-->            	
                ...
                <form class="form-horizontal no-margin"> 
                    ...
                    <label>Nama Kontraktor : Syarikat Nilam Bestari Berhad</label>
                    </div>
                    <div class="control-group">
                    <label>No. Pendaftaran Syarikat : 20991123-D</label>
                    </div>
                  </form>   
                        </div>
