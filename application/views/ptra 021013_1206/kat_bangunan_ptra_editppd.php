  ...
  <div class="tab-content" id="myTabContent">
    <div id="home" class="tab-pane fade active in">
      ...
      <div class="main-container">
        ...
        echo form_open('ptra/kat_bangunan_ptra_editppd',$attributes); ?>
      <!--panel 2--> 
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
      ...
      <!--/.END main-container-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('ptra/summary_ptra_editppd')?>" class="btn btn-danger input-top-margin" id="error">
                    Batal
                  </a>
                  <a href="<?php echo site_url('ptra/summary_ptra_editppd')?>" class="btn btn-warning2 input-top-margin" id="simpan">
                    Simpan
                  </a>
                <!--/.END buttons-->
