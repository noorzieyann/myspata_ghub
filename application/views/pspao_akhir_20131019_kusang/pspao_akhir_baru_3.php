    ...
    <!--END breadcrumb-->
		<div class="widget-body">                  
          <!--start div tab -->
<?php 
	$form_name = 'pspao/pspao_akhir_baru_4';
	if($this->uri->segment(3) != NULL){$form_name = 'pspao/pspao_akhir_baru_4/'.$this->uri->segment(3);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'pspao_akhir_baru_4');
...
.modal{
	...
	margin-left: -380px !important;
                  ...
                  <a href="#myLampir" data-toggle="modal">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe102;"> Tambah Anggaran Bajet</span>
                  </a>
...
<?php ///////////////////  END  MODAL SINI JAH ////////////////////////////  ?>
                ...
                <div class="next-prev-btn-container pull-right">
                    ...
                    <a href="<?php echo site_url('pspao/pspao_akhir_baru_2/'.$this->uri->segment(3)) ?>"><button class="btn btn-primary" type="button"> Sebelum </button></a>
