        ...
        <div class="main-container">
          ...
          <div class="alert alert-block alert-info fade in">
            ...
            <p>
              There are various form elements contained in Black Forest UI, date picker, color picker, time picker, date range, registration forms, horizontal forms, wysihtml5 editor, fluid forms, validation states, inputs, custom select controls, custom checkbox &amp; radio, custom input controls with &amp; without appended / prepended elements, toggle (on/off) many more.
            </p>
          </div>
          ...
          <div class="row-fluid">
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14c;"></span>  Different input sizes
                  </div>
                </div>
                <div class="widget-body">
                  ...
                  <input class="input-block-level no-margin" type="text" placeholder=".input-block-level">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Submit a ticket
                  </div>
                </div>
                <div class="widget-body">
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe170;"></span> Create new Blog 
                ...
                <div class="widget-body">
                  <form>
                    ...
                    <div class="control-group">
                      <div class="controls controls-row">
                        <input class="input-block-level" type="text" placeholder="Author">
                      </div>
                    </div>
                    <div class="control-group">
                      <div class="controls controls-row">
                        <input class="input-block-level" type="text" placeholder="Tags">
                      </div>
                    </div>
                  </form>
                  <div class="wysiwyg-container">
                    <textarea id="wysiwyg" class="input-block-level" placeholder="Enter text ..." style="height: 140px">
                    </textarea>
                  </div>
                </div>
              </div>
          ...
          <div class="row-fluid">
            ...
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1d6;"></span> Color picker
                  </div>
                </div>
                <div class="widget-body">
                  <form class="form-horizontal" action="#">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append color colorpicker" data-color="#1e825e" data-color-format="hex">
                          <input type="text" class="span8" value="#1e825e" id="color-picker-1" >
                          <span class="add-on btn" >
                            <i style="background-color: #1e825e">
                            </i>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append color colorpicker" data-color="rgb(181, 121, 158)" data-color-format="rgb">
                          <input type="text" class="span8" value="rgb(181, 121, 158)" id="color-picker-2" readonly="readonly">
                          <span class="add-on btn" >
                            <i style="background-color: rgb(181, 121, 158)">
                            </i>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append color colorpicker" data-color="rgb(87,157,169,0.78)" data-color-format="rgba">
                          <input type="text" class="span8" value="rgb(87,157,169,0.78)" id="color-picker-3" >
                          <span class="add-on btn" >
                            <i style="background-color: #579da9">
                            </i>
                          </span>
                        </div>
                      </div>
                ...
                <div class="widget-body">
                  <form class="form-horizontal" action="#">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append">
                          <input type="text" name="date_range2" id="date_range2" class="span8 date_picker" placeholder="Select Date"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append">
                          <input type="text" name="report_range1" id="report_range1" class="span8 report_range" placeholder="Select Date"/>
          ...
          <div class="row-fluid">
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe023;"></span> Create your account 
                    <span class="mini-title">
                  ...
                  <form class="form-horizontal no-margin">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        ...
                        <select name="City" class="span6 input-top-margin">
                          <option value="" selected="selected">
                            Select a City
                          </option>
                    ...
                    <div class="control-group success">
                      ...
                      <div class="controls">
                        <div class="input-prepend">
                          ...
                          <input class="span8" id="email2" type="text" placeholder="Email">
                        </div>
                      </div>
                    </div>
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" name="emailAddress" id="emailAddress" class="uneditable-input span3" placeholder="Enter your Email Address" />
                      </div>
                    </div>
                    <div class="control-group">
                      <div class="controls">
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b6;"></span> Wizard with navbar
                    <span class="mini-title">
                      ...
                      <div class="navbar-inner">
                        <div class="container">
                          <ul>
                            ...
                            <li>
                              <a href="#inverse-tab4" data-toggle="tab" class="hidden-phone">
                                Forth
                              </a>
                            </li>
                            <li>
                              <a href="#inverse-tab5" data-toggle="tab" class="hidden-phone">
                                Fifth
                              </a>
                            </li>
                            <li>
                              <a href="#inverse-tab6" data-toggle="tab" class="hidden-phone">
                                Sixth
                              </a>
                            </li>
                            <li>
                              <a href="#inverse-tab7" data-toggle="tab" class="hidden-phone">
                                Seventh
                              </a>
                            </li>
                          </ul>
          ...
          <div class="row-fluid">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append bootstrap-timepicker">
                          <input id="timepicker1" value="10:30 AM" type="text" readonly="readonly" class="span12">
                          <span class="add-on btn">
                            <i class="icon-time">
                            </i>
                          </span>
            ...
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe138;"></span> Checkbox and Radio
                  </div>
                </div>
                <div class="widget-body">
                  <label class="checkbox">
          ...
          <div class="row-fluid">
            ...
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b6;"></span> Horizontal Wizard Form
                  </div>
                </div>
                <div class="widget-body">
                  <form class="form-horizontal no-margin">
                    <div class="tab-content" id="myTabContent">
                      <div id="step1" class="tab-pane fade active in">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" class="span10" id="inputFirstName" placeholder="First Name">
                          </div>
                        </div>
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" class="span10" id="inputLastName" placeholder="Last Name">
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">
                          ...
                          <div class="controls">
                            <label class="radio inline">
                              <input type="radio" name="optionsRadios" id="inlineRadioA" value="optiona" checked>
                              Male
                            </label>
                            <label class="radio inline">
                              <input type="radio" name="optionsRadios" id="inlineRadioB" value="optionb">
                              Female
                            </label>
                          </div>
                        </div>
                      ...
                      <div id="step2" class="tab-pane fade">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <label class="radio inline">
                              <input type="radio" name="optionsRadios" id="inlineRadio1" value="option1">
                              a
                            </label>
                            <label class="radio inline">
                      ...
                      <div id="step3" class="tab-pane fade">
                        ...
                        <label class="checkbox inline" style="width:180px">
                          <input type="checkbox">
                          Terms &amp; Conditions
                        </label>
                      </div>
            ...
            <div class="span6">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14c;"></span> Validation States
                  </div>
                </div>
                <div class="widget-body">
                  <form class="form-horizontal no-margin" action="#">
                    <div class="control-group warning">
                      ...
                      <div class="controls">
                        <input type="text" class="span12" id="inputWarning">
                    ...
                    <div class="control-group error">
                      ...
                      <div class="controls">
                        <input type="text" class="span12" id="inputError">
                        <span class="help-inline">Correct the error</span>
                      </div>
                    </div>
                    ...
                    <div class="control-group info">
                      ...
                      <div class="controls">
                        <input type="text" class="span12" id="inputInfo">
                        <span class="help-inline">Already taken</span>
                      </div>
                    </div>
                    ...
                    <div class="control-group success">
                      ...
                      <div class="controls">
                        <input type="text" class="span12" id="inputSuccess">
