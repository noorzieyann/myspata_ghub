                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td> <div class="">
                                                        ...
                                                        <option value="<?php echo $rl->kump_pengguna; ?>" <?php if($rl->kump_pengguna===$rec->kump_pengguna){echo 'selected';} ?> ><?php echo set_value('nama_kump_pengguna', $rl->nama_kump_pengguna); ?></option>
                                                        <?php endforeach; ?>
                                                        <?php endif; ?>
                                                            </select>  </div><br>
                                                    </td>
