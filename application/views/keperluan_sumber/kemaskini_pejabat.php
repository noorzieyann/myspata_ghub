            ...
            <div id="home" class="tab-pane fade active in">
               ...
               <div class="row-fluid">
                    ...
                    <div class="widget-header">
                                <div class="title">
                                    <span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Keperluan Sumber- Pengurusan Pejabat
                                </div>
                    </div> 
                    <div class="widget-body">
                   
                                 
                                    <?php if (!empty($urusanpejabat)) : foreach ($urusanpejabat as $rec) : ?> 
                                    <?php 
                                    ...
                                    <table width="95%" border="0" align="center">
                                                    ...
                                                    <td width="31%"> 
                                                        <div class="">
                                                            <select class="required large" name="kat_alat_pej_id">
                                                                <?php if($getKatPej = $this->utilitikeperluansumber_model->get_kat_pej($rec->kat_alat_pej_id)) : foreach ($getKatPej as $row) :?>
                                                                <option value="<?php echo $rec->kat_alat_pej_id; ?>"><?php echo $row->alat_pej; ?></option>
                                                                <?php endforeach; endif; ?>
                                                                
                                                                <?php if(!empty($list)) : foreach ($list as $row) : ?>
                                                                <option value="<?php echo $row->kat_alat_pej_id; ?>"><?php echo set_value('alat_pej', $row->alat_pej); ?></option>
                                                                <?php endforeach; ?>
                                                                <?php endif; ?>
                                                            </select>                                            
                                                            <font color="red"><?php echo form_error('kat_alat_pej_id'); ?></font>
                                                        </div><br>
                                                    </td>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><div class="">
                                                            <?php echo form_input(array('name' => 'alat_pej_tag_no', 'value' => set_value('alat_pej_tag_no', $rec->alat_pej_tag_no), 'class' => 'large required')); ?>
