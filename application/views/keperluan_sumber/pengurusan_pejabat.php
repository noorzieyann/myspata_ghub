        ...
        <div class="widget-body">
           <ul class="nav nav-tabs no-margin myTabBeauty">
              ...
              <li class="active"><a href="<?php echo site_url('utilitiKeperluanSumber/tambahpejabat') ?>">Pengurusan Pejabat</a></li>
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Senarai Alat Pengurusan Pejabat
                  </div>
                </div>
                <div class="widget-body">
                    ...
                    <ul class="icomoon-icons-container">
                      ...
                      <label class="tambah">Tambah Pengurusan Pejabat</label>
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      <thead>
                        <tr>
                          ...
                          <th style="width:20%">Kategori Pengurusan Pejabat</th>
                      ...
                      <tbody>
                            <?php $i=1; if(!empty($urusanpejabat)) : foreach ($urusanpejabat as $rec) : ?>
                            <?php echo form_open('admin/update'); ?>
                        
                            <tr>
                                <td align="left"><?php echo $i++; ?></td>
                                <td><?php if($getKat = $this->utilitikeperluansumber_model->get_kat_pej($rec->kat_alat_pej_id))
    					foreach ($getKat as $rr) 
     						echo $rr->alat_pej;?></td>
                                <td><?php echo $rec->jenama; ?></td>
                                <td><?php echo $rec->spesifikasi; ?></td>
                                <td><?php echo $rec->alat_pej_tag_no; ?></td>
                                 <td><?php echo $rec->kos_seunit; ?></td>
                                <td align="center"><ul class="icomoon-icons-container"> <li class="rounded"><span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php base_url(); ?>kemaskinipejabat/<?php echo $rec->urus_pej_id; ?>"></a>
                                    </span></li></ul>
                                </td>
                            </tr>
                                <?php echo form_close(); ?>
             ...
             <form id="" class="" action="tambahpejabat" method="post"> 
                      ...
                      <div class="modal-body">
                                ...
                                <table width="95%" border="0" align="center">
                                            <tr>
                                                ...
                                                <td width="31%"> 
                                                    <div class="">
                                                    <select class="required large" name="kat_alat_pej_id">
                                                <option value="">SILA PILIH</option>
                                                <?php if(!empty($uruspejabat)) : foreach ($uruspejabat as $rec) : ?>
                                                <option value="<?php echo $rec->kat_alat_pej_id; ?>"><?php echo set_value('alat_pej', $rec->alat_pej); ?></option>
                                                <?php endforeach; ?>
                                                <?php endif; ?>
                                            </select>
...
<tr>
                                                ...
                                                <td width="33%">
                                                    <div class=""><?php echo form_input(array('name' => 'jenama1', 'value' => set_value('jenama', $this->session->userdata('jenama')), 'class' => 'large required')); ?>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><div class="">
                                                            <?php echo form_input(array('name' => 'alat_pej_tag_no', 'value' => set_value('alat_pej_tag_no', $this->session->userdata('alat_pej_tag_no')), 'class' => 'large required')); ?>
                                                            <font color="red"><?php echo form_error('alat_pej_tag_no'); ?></font>
                                                        </div><br>
                                                  </td>
                                                </tr>
                                                <tr>
