  ...
  <div class="tab-content" id="myTabContent">
        ...
        <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'arahan_penyediaan_ppun',
                           'id' => 'arahan_penyediaan_ppun',
                        );
        echo form_open('ppun/arahan_penyediaan_ppun',$attributes); ?>
        <!--panel 1-->  
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span>  Sila Pilih Penerima Arahan Penyediaan PPUN
                  </div>
                </div>
                <div class="widget-body">
    ...
    <!--panel 2-->
      ...
      <!--buttons--> 
                  ...
                  <a class="btn btn-success input-top-margin pull-right" href="#" id="hantar">
                    Hantar
                  </a>
                </div> 
                <!--/.END buttons--> 
     ...
     <script type="text/javascript">
      ...
      reset = function () {
       ...
       $("hantar").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menghantar Pelan Pemulihan / Ubah Suai / Naik Taraf ini?", function (e) {
          if (e) {
              
             ///document.forms["arahan_penyediaan_pnpa"].submit();
            alertify.success("Anda klik ya");
			windows.replace("<?php echo  site_url("ppun/senarai_ptf_ppun")?>");
      ...
      $("simpan").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menyimpan Pelan Pemulihan / Ubah Suai / Naik Taraf Aset ini?", function (e) {
          if (e) {
