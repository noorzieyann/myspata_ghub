 ...
 <ul class="nav nav-tabs no-margin myTabBeauty">
          ...
          <div class="tab-content" id="myTabContent">
              <div id="ppun" class="tab-pane fade active in">
                    ...
                    echo form_open('ppun/summary_ptf_ppun',$attributes); ?>
...
<script type="text/javascript">
      ...
      reset = function () {
       ...
       $("sah").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin mengesahkan Pelan Pemulihan / Ubah Suai / Naik Taraf Aset ini?", function (e) {
          if (e) {
              
              document.forms["summary_ptf_ppun"].submit();
      ...
      $("betul").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin membetulkan Pelan Pemulihan / Ubah Suai / Naik Taraf Aset ini?", function (e) {
          if (e) {
