                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/treeviewskop_popa_edit')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/kawalan_rekod_popa_edit')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></a></li>
