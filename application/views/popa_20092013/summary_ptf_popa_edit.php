      ...
      <div class="main-container">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/model_struktur_popa_edit') ?>">                       
                        <ul class="icomoon-icons-container">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/treeview_popa_edit') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a href="<?php echo site_url('popa/treeviewskop_popa_edit') ?>">                        
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a> 
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a href="<?php echo site_url('popa/kawalan_rekod_popa_edit') ?>">                        
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>  
                        <td class="hidden-phone">
                          <span class="badge">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>
                        <td class="hidden-phone">  
                          <span class="badge">
        ...
        <!--panel 4-->  
         ...
         <!--/.END panel 4-->
   				...
   				<!--buttons--> 
                 <div align="right">
               <a href="<?php echo site_url('popa/senarai_ppd_popa') ?>"><button class="btn btn-danger input-top-margin" type="button">Batal</button></a>
  ...
  <!--/.END tab section-->
    ...
    <script type="text/javascript">
      ...
      $("sah").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin mengesahkan rekod POPA ID POPA00002?", function (e) {
          if (e) {

            window.location ="<?php echo site_url('popa/senarai_pof_popa') ?>";
