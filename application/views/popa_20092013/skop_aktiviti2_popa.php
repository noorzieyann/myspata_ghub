        ...
        <div class="row-fluid">
            <div class="span12">
                    ...
                    <?php //echo validation_errors(); ?>
                        <?php 
                            $attributes = array(
                                ...
                                'name' => 'skop_aktiviti2_popa',
                                'id' => 'skop_aktiviti2_popa',
                            );
                            echo form_open('main/skop_aktiviti2_popa',$attributes); ?>
                ...
                <div class="widget-body" align="right">
                    ...
                    <a href="<?php echo site_url('popa/skop_aktiviti_popa') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Seterusnya
                      </button></a>
                </div> 
                <!-- buttons END -->         
