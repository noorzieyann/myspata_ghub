                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('pnpa/model_struktur_pnpa_edit_ppd') ?>">                       
                        <ul class="icomoon-icons-container">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('pnpa/treeview_pnpa_edit_ppd') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a href="<?php echo site_url('pnpa/kawalan_rekod_pnpa_edit_ppd') ?>">                        
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>  
                        <td class="hidden-phone">
                          <span class="badge">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('pnpa/dokumen_rujukan_pnpa_edit_ppd') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">  
                          <span class="badge">
         ...
         <!--/.END panel 4-->
          ...
          <!--buttons--> 
               ...
               <button class="btn btn-warning2 hidden-tablet" type="button">
                  ...
                  <button class="btn btn-success" type="button" id="hantar">
                    Hantar
                  </button>
             </div></form>
