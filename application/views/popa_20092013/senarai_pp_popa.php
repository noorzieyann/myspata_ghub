...
<div class="widget-body"> 
    <ul class="nav nav-tabs no-margin myTabBeauty"> 
        <li class=""> 
            <a data-toggle="tab" href="#profile" data-original-title=""> PSPA(O)</a> 
        </li> 
        <li class=""> 
            <a data-toggle="tab" href="<?php echo site_url('ptra/senarai_ptf_ptra')?>" data-original-title=""> PTRA </a> 
        </li> 
        <li class="active"> 
            <a data-toggle="tab" href="<?php echo site_url('popa/senarai_ptf_popa')?>" data-original-title=""> POPA </a> 
        </li>
        <li class=""> 
            <a data-toggle="tab" href="<?php echo site_url('pnpa/senarai_ptf_pnpa')?>" data-original-title=""> PNPA </a> 
        </li>
        <li class=""> 
            <a data-toggle="tab" href="<?php echo site_url('ppun/senarai_ptf_ppun')?>" data-original-title=""> PPUN </a> 
        </li> 
        <li class=""> 
            <a data-toggle="tab" href="<?php echo site_url('pla/senarai_ptf_pla')?>" data-original-title=""> PLA </a> 
        </li>   
    </ul> 
