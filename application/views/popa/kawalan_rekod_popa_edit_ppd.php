      ...
      <?php if(!empty($tab)) { echo $tab;} ?>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <ul class="icomoon-icons-container">
                           <li class="rounded">
                            <span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/popa/kemaskinikawalan_rekod_ppd/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->popa_pata_f7_1d_id; ?>">
                                        </a>
                                    </span></li></ul>
                                </td>
                            </tr>
        ...
        <!--/.END panel 1-->
                ...
                <a href="<?php echo site_url('popa/summary_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('popa/summary_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-warning2 input-top-margin" type="button">
                        Simpan
                      </button></a>
                     </div>
                     <!--end div button -->   
