...
if($this->uri->segment(5) != NULL){
	if(count($this->skopaktiviti_model->get_skop_from_segment2($this->uri->segment(4),$this->uri->segment(5),'popa')) == 0){
		$check_row = 0;
                $pihakkaitan='';
                $tjawab='';
                $tarikh_mula='';
		...
		foreach($this->skopaktiviti_model->get_skop_from_segment2($this->uri->segment(4),$this->uri->segment(5),'popa') as $row){

			$popa_id=$row->popa_id;
			$skop_aktvt_id=$row->skop_aktvt_id;
			$pihakkaitan=$row->f7_1b1c_pihak_berkaitan;
			$tjawab=$row->f7_1b1c_tanggungjawab;
			$tarikh_mula=$row->f7_1b1c_tarikh_mula;
			$tarikh_akhir=$row->f7_1b1c_tarikh_tamat;
			$catatan=$row->catatan;
...
<div class="widget-body">
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='popa/skop_aktiviti2_popa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
	
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_popa_edit_ppd');
    ...
    <?php echo validation_errors(); ?>
		...
		<div class="span12">
                ...
                <div class="widget-body">
					...
					<?php if($getSko = $this->skopaktiviti_model->get_lkpskopbutiran_1( $this->uri->segment(4),  $this->uri->segment(5),'popa')):
							foreach ($getSko as $rrq) :?>
                   
					<?php if($getSko = $this->skopaktiviti_model->get_lkpskopaktiviti_1( $this->uri->segment(4), $rrq->skop_aktvt_sort, 'popa')):
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb=0; ?>
                        ...
                        <?php 	
							if($this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),'popa')== FALSE)
							{ 
								echo ''; 
								?>    
                       ...
                       <?php
							...
							$runQuery = $this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),'popa');
							foreach ($runQuery as $rQ){$idExisting = $rQ->popa_pata_f7_1b1c_sumber_man_id; }			
                       ?>    
                            ...
                            <?php if($this->skopaktiviti_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),1,'popa')== FALSE)
								{
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb2=0; ?>
                        <?php if(!empty($senarai_sumber)) : foreach ($senarai_sumber as $rec) : ?>
                        <?php if($this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),'popa')== FALSE)
                                { 
                                 echo ''; 
                       ...
                       <?php  }else 
                            {
							$runQuery = $this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),'popa');
							foreach ($runQuery as $rQ){$idExisting = $rQ->popa_pata_f7_1b1c_sumber_man_id; }			
                       ?>    
                       ...
                       <?php 
								...
								if($this->skopaktiviti_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),1,'popa')== FALSE)
								{
									$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
                                }
                                else 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb3=0; ?>
                        <?php if(!empty($senarai_sumber)) : foreach ($senarai_sumber as $rec) : ?>
                        <?php if($this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5),'popa')== FALSE)
                                { 
                                 echo ''; 
                       ...
                       <?php  }
                            ...
                            {
                                $runQuery = $this->skopaktiviti_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5),'popa');
								foreach ($runQuery as $rQ){$idExisting = $rQ->popa_pata_f7_1b1c_sumber_man_id; }			
                       ?>    
                            ...
                            <label class="checkbox">
                               ...
                               <?php echo $rec->nama; ?>
                            <?php if($this->skopaktiviti_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5),1,'popa')== FALSE)
								{
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calVal = 0; $count=1; if(!empty($senarai_alat_pej)) : foreach ($senarai_alat_pej as $rec1) : ?>
									...
									<?php if($checkPjbt = $this->skopaktiviti_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec1->urus_pej_id,$rec1->kat_alat_pej_id,'popa')) { echo "checked"; } 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calValFax=0; $autoNumb=1; if(!empty($senarai_fax)) : foreach ($senarai_fax as $rec2) : ?>
							...
							<?php if($checkPjbt = $this->skopaktiviti_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec2->urus_pej_id,$rec2->kat_alat_pej_id,'popa')) { echo "checked"; } 
             ...
             <div class="span4">
                ...
                <div class="widget-body">
                  ...
                  <label class="checkbox">
                         ...
                         <label class="checkbox">
							  ...
							  <?php if($checkPjbt = $this->skopaktiviti_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec3->urus_pej_id,$rec3->kat_alat_pej_id,'popa')) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKom=0; $count=1; if(!empty($senarai_kom)) : foreach ($senarai_kom as $rec4) : ?>
                          <label class="checkbox">
							 ...
							 class="machKom" 
							 <?php if($checkAlat = $this->skopaktiviti_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec4->alat_kerja_id,$rec4->kat_alat_kerja_id,'popa')) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValPeriksa=0; $count=1; if(!empty($senarai_pemeriksa)) : foreach ($senarai_pemeriksa as $rec7) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->skopaktiviti_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec7->alat_kerja_id,$rec7->kat_alat_kerja_id,'popa')) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKend=0; $count=1; if(!empty($senarai_kenderaan)) : foreach ($senarai_kenderaan as $rec5) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->skopaktiviti_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec5->alat_kerja_id,$rec5->kat_alat_kerja_id,'popa')) { echo "checked"; } 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calValPPE=0; $count=1; if(!empty($senarai_ppe)) : foreach ($senarai_ppe as $rec6) : ?>
                            ...
                            <label class="checkbox">
                             <input id="ppe<?php echo $count; ?>" type="checkbox" value="<?php echo $rec6->alat_kerja_id; ?>cb<?php echo $rec6->kos_seunit; ?>" name="ppe[]"
							  ...
							  <?php if($checkAlat = $this->skopaktiviti_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec6->alat_kerja_id,$rec6->kat_alat_kerja_id,'popa')) { echo "checked"; } 
                     ...
                     <a href="<?php echo site_url('popa/skop_aktiviti_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
...
$(document).ready(function(){ 
	$('.planning').click(function(){
		...
		{ 
			...
			$.ajax({
                type: "POST",
                url: "<?php echo site_url(); ?>/popa/set_skop_aktiviti/"+jgk, 
