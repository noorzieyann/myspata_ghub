<!--breadcrumb-->
   ...
   <div class="clearfix"></div>
    ...
    <?php 
  $form_name = 'popa/kawalan_rekod_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'popa/kawalan_rekod_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kawalan_rekod_popa');
...
?>
          ...
          <div class="span12">
            <div class="widget">
              <div class="widget-header">
                <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Kawalan Rekod Operasi & Penyenggaraan Aset
                </div>
              </div>
                <!--table section-->              
                <div class="widget-body"> 
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $rec->f7_1d_jenis_rekod; ?></td>
                        <td><?php echo $rec->f7_1d_lokasi; ?></td>
                        ...
                        <td align="center">
                          <ul class="icomoon-icons-container">
                           <li class="rounded">
                            <span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/popa/kemaskinikawalan_rekod/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->popa_pata_f7_1d_id; ?>">
                                        </a>
                                    </span></li></ul>
                                </td>
                            </tr>
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                   <a href="<?php echo site_url('popa/senarai_ppd_popa/'.$this->uri->segment(3))?>"><button class="btn btn-danger input-top-margin" type="button">
                                            Batal</button></a>
                  <a href="<?php echo site_url('popa/skop_aktiviti_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('popa/dokumen_rujukan_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
  ...
  <!--/.END tab section-->
    ...
    <!--/.END tab navigation-->
     ...
     <!--popup-->
      <!--  <form id="" class="" action="kawalan_rekod_popa/<?php //echo $this->uri->segment(3).'/'.$this->uri->segment(4) ?>" method="post">-->
            ...
            <div class="modal-body">
              <p>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('name' => 'jenis_rekod1', 'value' => set_value('f7_1d_jenis_rekod', $this->session->userdata('f7_1d_jenis_rekod')), 'class' => 'large required')); ?>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls"><?php echo form_input(array('name' => 'lokasi1', 'value' => set_value('f7_1d_lokasi', $this->session->userdata('f7_1d_lokasi')), 'class' => 'large required')); ?>
