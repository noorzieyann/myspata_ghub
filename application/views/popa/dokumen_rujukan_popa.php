<!--breadcrumb-->
   ...
   <div class="clearfix"></div>
    ...
    <!--breadcrumb--><?php if(!empty($tab)) { echo $tab;} ?>
     ...
     <?php 
  $form_name = 'popa/dokumen_rujukan_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'popa/dokumen_rujukan_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'dokumen_rujukan_popa');
...
?>
        ...
        <!--popup-->
    <?php //echo form_open_multipart('popa/dokumen_rujukan_popa');?>
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table" >    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('popa/muat_dokumen_rujukan_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>"><?php echo $rec->nama_fail_asal; ?></a></td>
                                <td align="center">
                                    <ul class="icomoon-icons-container">
                                    <a class="confirmation" href="<?php echo site_url('popa/hapus_dokumen_rujukan_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>">
                                      <li class="rounded">
                                        <span class="fs1" data-icon="&#xe0a7" aria-hidden="true" id="hapus1" ></span></li></a>                                    
                                    </ul>
                                </td>
                            </tr>
                            <?php //echo form_close(); ?>
          ...
          <!--END panel 2-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('popa/senarai_ppd_popa/'.$this->uri->segment(3))?>"><button class="btn btn-danger input-top-margin" type="button">
                                            Batal</button></a>
                  <a href="<?php echo site_url('popa/kawalan_rekod_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('popa/summary_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
...
<div class="modal-body"><p>Adakah anda ingin menyimpan deraf POPA ini?</p></div>
  ...
  ?>
    ...
    $("hapus").onclick = function () {
       ...
       self.location="<?php echo site_url('popa/hapus_dokumen_rujukan_popa/'.$this->uri->segment(3));?>";
          } 
        });
        return false;
      };
