                       ...
                       <?php $cnt=$this->skopaktiviti_model->get_lkpskopbutiran_count($rrr->skop_aktvt_id,'popa');
						...
						?>
                         ...
                         <?php if($getSko = $this->skopaktiviti_model->get_lkpskopbutiran($rrr->skop_aktvt_id,  $this->uri->segment(4),'popa')):
								...
								<td class="hidden-phone"><a href="<?php echo site_url()?>/popa/skop_aktiviti2_popa/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php  echo $rrq->skop_aktvt_id; ?>">
...
<?php $popaID = $this->uri->segment(4); ?>
                ...
                <div class="widget-body" align="right">
                  <a href="<?php echo site_url('popa/treeviewskop_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
  ...
  <!--/.END tab section-->
    ...
    <!--/.END tab navigation-->
<?php echo form_open('popa/skop_aktiviti_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5)); ?>
