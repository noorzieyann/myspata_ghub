                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <div class="title">
                                ...
                                </span> Kemaskini Kawalan Rekod POPA
                            </div>
                        </div> 
                        ...
                        <?php if (!empty($senarai_kawalan)) : foreach ($senarai_kawalan as $rec) : ?>
                            ...
                            <form id="" class="" action="" method="post">
                                        ...
                                        <td width="20%">
                                            <div class="">
                                                ...
                                                <?php echo form_input(array('name'  => 'jenis_rekod1', 
                                                                            'value' => set_value('jenis_rekod1', $rec->f7_1d_jenis_rekod),
                                        ...
                                        <td width="20%">
                                            <div class="">
                                                ...
                                                <?php echo form_input(array('name'  => 'lokasi1',
                                                                            'value' => set_value('lokasi1', $rec->f7_1d_lokasi), 
                                                                            'class' => 'input-xlarge required')); 
                                                ?>
                                ...
                                <input type="hidden" name="no" value="<?php echo $rec->popa_id; ?>">
