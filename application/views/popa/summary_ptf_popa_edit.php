<!-- page: summary popa edit for ptf, by seri idayu, 22092013 -->
...
<div class="widget-body"> 
  <ul class="nav nav-tabs no-margin myTabBeauty"> 
    ...
    <li class="active"> 
      <a data-toggle="tab" href="<?php echo site_url('popa/senarai_ptf_popa')?>" data-original-title=""> 
        POPA 
      </a> 
    </li>
    <li class=""> 
      ...
      <h5 style="color:#FF0000">
        90%
          <a class="alert-heading">
            dokumen ini telah dilengkapkan
          </a>
      </h5>
    </div>
    <!-- status info END -->
      ...
      <div class="main-container">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Carta Organisasi dan Pelan Komunikasi
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Skop dan Aktiviti Operasi dan Penyenggaraan Aset
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Penyediaan Keperluan Sumber Aktiviti Operasi dan Penyenggaraan Aset
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                      ...
                      <!-- popup penyediaan keperluan START -->
                      ...
                      <!-- popup penyediaan keperluan END -->
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Kawalan Rekod Operasi dan Penyenggaraan Aset
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/model_struktur_popa_edit_ptf')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/treeviewskop_popa_edit_ptf')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/kawalan_rekod_popa_edit_ptf')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit_ptf')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
        ...
        <div class="next-prev-btn-container ">
          <div class="widget-body" align="right">
            <a href="<?php echo site_url('popa/senarai_ptf_popa')?>">
            ...
            <button class="btn btn-success input-top-margin" type="button" id="sah">
              Sah
            </button>
          </div>   
        </div>
  ...
  <script type="text/javascript">
    ...
    return document.getElementById(id);
      ...
      $("sah").onclick = function () {
        reset();
        alertify.confirm("Adakah ingin mengesahkan rekod POPA ID POPA00002?", function (e) {
          if (e) {

            window.location ="<?php echo site_url('popa/senarai_ptf_popa') ?>";
