<!-- page: summary popa for ppd to edit, by seri idayu, 01102013 -->
  ...
  <div class="tab-content" id="myTabContent">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/model_struktur_popa_edit_ppd') ?>">                       
                        <ul class="icomoon-icons-container">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/treeviewskop_popa_edit_ppd') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a href="<?php echo site_url('popa/kawalan_rekod_popa_edit_ppd') ?>">                        
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>  
                        <td class="hidden-phone">
                          <span class="badge">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit_ppd') ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></ul></a>
                        <td class="hidden-phone">  
                          <span class="badge">
        ...
        <!--/.END panel 3-->
          ...
          <div class="widget-body" align="right">
              ...
              <button class="btn btn-danger input-top-margin" type="button">
               ...
               <button class="btn btn-info input-top-margin" type="button" id="simpan">
                    Simpan
                  </button>
                  <button class="btn btn-success input-top-margin" type="button" id="hantar">
                    Hantar
                  </button>
             </div></form>
    ...
    <script type="text/javascript">
      ...
      $("hantar").onclick = function () {
        reset();
        alertify.confirm("Adakah anda ingin menghantar rekod POPA ID POPA00003?", function (e) {
          if (e) {
