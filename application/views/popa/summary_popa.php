...
<?php if(!empty($tab)) { echo $tab;} ?>
    ...
    <div class="alert alert-block alert-info fade in">
      ...
      <?php 
        ...
        if($this->popa_model->get_status_summary($this->uri->segment(4)))
        { 
          $lengkap++;
        }


        if($this->popa_model->get_status_summary2($this->uri->segment(4)))
        {
          $lengkap = $lengkap+2;
        }


        if($this->popa_model->get_status_summary3($this->uri->segment(4)))
        {
          $lengkap++;
        }


        if($this->popa_model->get_status_summary4($this->uri->segment(4)))
        { 
          $lengkap++;
        }
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Pelan Operasi & Penyenggaraan Aset (POPA)
                  </div>
                </div>
...
<?php
$attributes = array('class' => 'form-horizontal no-margin','name'  => 'summary_popa','id'    => 'summary_popa');
echo form_open('popa/summary_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4),$attributes);
?>
            ...
            <table class="table table-condensed table-striped table-bordered table-hover no-margin">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="hidden-phone">
                    Model Struktur Operasi & Penyenggaraan Aset di Premis (JKR.PATA.F7/1a)
                  </td>
                  

                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('popa/model_struktur_popa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Skop dan Aktiviti Operasi & Penyenggaraan Aset (JKR.PATA.F7/1b)
                  </td>
                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('popa/treeview_popa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/edit') ?>">                         
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Format Analisis Keperluan Sumber Aktiviti Operasi & Penyenggaraan Aset (JKR.PATA.F7/1c)
                  </td>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Kawalan Rekod Operasi & Penyenggaraan Aset (JKR.PATA.F7/1d)
                  </td>
              
                  <td class="hidden-phone"> 
                    <a data-original-title="kemaskini" href="<?php echo site_url('popa/kawalan_rekod_popa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Dokumen Rujukan (JKR.PATA.F7/1e)
                  </td>
      
                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('popa/dokumen_rujukan_popa_edit_ppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
  ...
  <div class="next-prev-btn-container pull-right">
                ...
                <a type="button" class="btn btn-danger" href="<?php echo site_url('popa/senarai_ppd_popa/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>" data-toggle="modal">Batal</a>
