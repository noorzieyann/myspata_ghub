<!-- page: summary popa edit pegawai pengawal, by seri idayu, 20092013 -->
      ...
      <div class="main-container">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Model Struktur Operasi dan Penyenggaraan Aset
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/model_struktur_popa_edit_pp')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Skop dan Aktiviti Operasi dan Penyenggaraan
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          Format Analisis Keperluan Sumber Aktiviti Operasi dan Penyenggaraan Aset
                        </td>
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/kawalan_rekod_popa_edit_pp')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">
                          <ul class="icomoon-icons-container">
                            <li class="rounded">
                              <a href="<?php echo site_url('popa/dokumen_rujukan_popa_edit_pp')?>">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                              </a>
                            </li>
        ...
        <div class="next-prev-btn-container ">
          <div class="widget-body" align="right">
            <a href="<?php echo site_url('popa/senarai_pp_popa')?>">
