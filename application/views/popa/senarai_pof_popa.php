<!-- page: senarai pof popa, by seri idayu, 18092013 -->
...
<div class="widget-body"> 
  <ul class="nav nav-tabs no-margin myTabBeauty"> 
    <li class=""> 
      <a data-toggle="tab" href="#home" data-original-title=""> 
        PSPA(O)
      </a> 
    </li> 
    <li class=""> 
      <a data-toggle="tab" href="<?php echo site_url('ptra/senarai_ptf_ptra')?>" data-original-title="" data-original-title=""> 
        PTRA 
      </a> 
    </li> 
    <li class="active"> 
