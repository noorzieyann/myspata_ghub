<!-- page: model struktur popa edit bagi pof, by seri, 10092013 -->
...
<div class="widget-body"> 
    <ul class="nav nav-tabs no-margin myTabBeauty"> 
        ...
        <li class=""> 
            <a href="<?php echo site_url('ptra/senarai_pof_ptra')?>" data-original-title="">
                PTRA
            </a> 
        </li> 
        <li class="active"> 
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <ul class="nav nav-tabs no-margin myTabBeauty">
                                ...
                                <li class="">
                                    <a href="<?php echo site_url('popa/model_struktur_popa_edit_pof2')?>">
                                        Luaran
                                    </a>
                                </li>
                            </ul>
