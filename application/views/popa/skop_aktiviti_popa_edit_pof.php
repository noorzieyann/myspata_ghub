<!-- page: skop dan aktiviti popa for pof to edit, by seri idayu, 22092013 -->
  ...
  <div class="tab-content" id="myTabContent">
    <div id="home" class="tab-pane fade active in">
              ...
              <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                ...
                <tbody>
                  <tr>
                    ...
                    <td rowspan="10" class="hidden-phone">
                      Operasi Aset
                    </td>
                  ...
                  <tr>
                    <td rowspan="4" class="hidden-phone">
                  ...
                  <tr>
                    <td class="hidden-phone">
                      Gangguan Bekalan elektrik Utama
                    </td>
                    <td class="hidden-phone">
                      70, 000
                    </td>
                  ...
                  <tr>
                    ...
                    <td rowspan="5" class="hidden-phone">
                      Penyenggaraan Am/Rutin
                    </td>
                    <td class="hidden-phone">
                      Pengurusan Pengemasan 
                    </td>
                    <td class="hidden-phone">
                      &nbsp;
                    </td>
                  ...
                  <tr>
                    <td class="hidden-phone">
                      Pengurusan Pelupusan Sisa Buangan
                    </td>
                    <td class="hidden-phone">
                      &nbsp;
                    </td>
                  ...
                  <tr>
                    <td class="hidden-phone">
                      Pengurusan Kawalan Makhluk Perosak
                    </td>
                    <td class="hidden-phone">
                      &nbsp;
                    </td>
                  ...
                  <tr>
                    ...
                    <td rowspan="4" class="hidden-phone">
                      Penyenggaraan Khidmat Pembaikan
                    </td>
                    <td class="hidden-phone">
      ...
      <div class="widget-body" align="right">
        <a href="<?php echo site_url('popa/treeviewskop_popa_edit_pof') ?>">
