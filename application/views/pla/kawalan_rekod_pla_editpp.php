    ...
    <!--/.END popup-->
                      ...
                      <tr>
                        ...
                        <td align="center">                       
                          <ul class="icomoon-icons-container">
                            <a href="<?php //echo site_url('ptra/summary_pp_pla_editpp')?>"><li class="rounded"><span class="fs1" data-icon="&#xe005" aria-hidden="true"></span></li></a>
                              </ul>                   
                      </td>
                            </tr>
                            <?php echo form_close(); ?>
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('ptra/summary_pp_pla_editpp') ?>"><button class="btn btn-danger input-top-margin" type="button">
                        Batal
                  </button></a>
                  <a href="<?php echo site_url('ptra/summary_pp_pla_editpp')?>"><button class="btn btn-warning2 input-top-margin" type="button">
                    Simpan
                  </button></a>
                </div> 
                <!--/.END buttons-->   
