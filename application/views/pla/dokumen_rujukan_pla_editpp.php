        ...
        <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'dokumen_rujukan_pla_editpp',
                           'id' => 'dokumen_rujukan_pla_editpp',
                        );
        echo form_open('ptra/dokumen_rujukan_pla_editpp',$attributes); ?>
        ...
        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <!--END panel 2-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('ptra/kawalan_rekod_pla')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('ptra/summary_pp_pla')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
                </div> 
                <!--/.END buttons--> 
