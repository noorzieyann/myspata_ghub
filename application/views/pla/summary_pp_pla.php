...
<div class="widget-body">
  ...
  <?php
    ...
    echo form_open('pla/summary_pp_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4),$attributes);
  ?>
...
<?php ///////// body utama /////////// ?>
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('pla/model_struktur_pla_editpp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                        <ul class="icomoon-icons-container">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"><a href="<?php echo site_url('pla/skop_aktiviti_pla_editpp/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone"> <a href="<?php echo site_url('pla/kawalan_rekod_pla_editpp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                        
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>  
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                      ...
                      <tr>
                        <td>
                          <span class="name">
                            5</span></td>
                        <td class="hidden-phone">Dokumen Rujukan Pelupusan Aset (JKR.PATA.F10/1e)</td>
                        <td class="hidden-phone"><a href="<?php echo site_url('pla/dokumen_rujukan_pla_editpp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></ul></a>
                        <td class="hidden-phone">  
                          <span class="badge badge-success">
  ...
  <div class="next-prev-btn-container pull-right">
        ...
        <a href="<?php echo site_url(); ?>/pla/senarai_ppd_pla/<?php echo $this->uri->segment(3);?>">    
        <?php
        $batal = array(
            'name'    => '',
            'id'      => '',
