...
if($this->uri->segment(3) != NULL){
	foreach($this->pla_model->get_pla_from_segment($this->uri->segment(3)) as $row){
...
?>  
    ...
    <br /> 
    <?php 
	$form_name = 'pla/kandungan_pla';
	if($this->uri->segment(3) != NULL){$form_name = 'pla/kandungan_pla/'.$this->uri->segment(3);}
...
<ul class="nav nav-tabs no-margin myTabBeauty">
  ...
  <div class="tab-content" id="myTabContent">
    <div id="home" class="tab-pane fade active in">
        <form id="" class="form-horizontal no-margin" action="kandungan_pla" method="post" name="pla/kandungan_pla">
          ...
          <div class="span12">
            <div class="widget">
              ...
              <div class="widget-body">
                  ...
                  <div class="control-group">
                      <label>3.0 Carta Organisasi Dan Pelan Komunikasi  <span class="popover-pop" data-original-title="3.0 Carta Organisasi dan Pelan Komunikasi" data-content="Struktur organisasi dan pelan komunikasi perlu disediakan bagi menerangkan organisasi pelaksanaan pelupusan aset (Sebagaimana JKR.PATA.F10/1a)." data-placement="right" class="fs1" aria-hidden="true" data-icon="&#xe0f7;"></span>
                      </label>    
                    <div class="wysiwyg-container">
                        <?php
                                $carta = $kand_detail[2];
                  ...
                  <div class="control-group">
                      <label>4.0 Skop Dan Aktiviti Pelupusan Aset  <span class="popover-pop" data-original-title="4.0 Skop dan Aktiviti Pelupusan Aset" data-content="PTF perlu menentukan/ menetapkan keperluan teknikal, proses, tempoh pelaksanaan, keperluan sumber, tanggungjawab dan kuasa pegawai yang terlibat bagi aktiviti berikut: (Sebagaimana JKR.PATA.F10/1b)" data-placement="right" data-icon="&#xe0f7;"></span>
                      </label>
                    <div class="wysiwyg-container">
                        <?php
                                $skop = $kand_detail[3];
                    ...
                    <?php 
                     ...
                     echo form_textarea($data); ?>
                        <input type="hidden" name="kand_utama_skop" value="Skop dan Aktiviti Pelupusan Aset">
                  ...
                  <div class="control-group">
                      <label>5.0 Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset  <span class="popover-pop" data-original-title="5.0 Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset" data-content="PTF hendaklah menyediakan Analisis Keperluan Sumber Aktiviti Pelupusan Aset bagi tujuan permohonan peruntukan (Sebagaimana JKR.PATA.F10/1c)." data-placement="right" data-icon="&#xe0f7;"></span>
                      </label>
                    <div class="wysiwyg-container">
                        <?php
                    ...
                    <?php 
                     ...
                     echo form_textarea($data); ?>
                        <input type="hidden" name="kand_utama_sumber" value="Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset">
                  ...
                  <div class="control-group">
                      <label>6.0 Kawalan Rekod Pelupusan Aset  <span class="popover-pop" data-original-title="6.0 Kawalan Rekod Pelupusan Aset" data-content="Kawalan rekod pelupusan aset sebagaimana JKR.PATA.F10/1d." data-placement="right" data-icon="&#xe0f7;"></span></span>
                      </label>
                    <div class="wysiwyg-container">
                        <?php
                    ...
                    <?php 
                     ...
                     echo form_textarea($data); ?>
                        <input type="hidden" name="kand_utama_kawalan" value="Kawalan Rekod Pelupusan Aset">
                  ...
                  <div class="control-group">
                      <label>7.0 Rujukan  <span class="popover-pop" data-original-title="7.0 Rujukan" data-content="Sebarang dokumen yang dirujuk dalam penyediaan PLA sebagaimana JKR.PATA.F10/1e." data-placement="right"data-icon="&#xe0f7;"></span>
                      </label>
                    <div class="wysiwyg-container">
                        <?php
