                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('pla/model_struktur_pla_editpp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></a></span></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('pla/treeview_pla_editpp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></a></span></li></ul>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('pla/kawalan_rekod_pla_editpp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></a></span></li></ul>  
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('pla/dokumen_rujukan_pla_editpp')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></a></span></li></ul>
                        <td class="hidden-phone">  
                          <span class="badge">
                            Deraf
                          </span>
  ...
  <script type="text/javascript">
      ...
      $("lulus").onclick = function () {
        ...
        alertify.confirm("Adakah anda ingin mengesahkan rekod PLA ID PLA 00002?", function (e) {
          if (e) {
            alertify.success("Rekod PLA ID PLA 00002 telah disahkan");
          } else {
