    ...
    <!--END breadcrumb-->
     <br />
      <div class="widget-body">
         ...
         <p>
         <form action='model_struktur_pla' method='post'>
           <!--start div panel Model struktur -->           
           <div class="row-fluid">
           <div class="span12">
           <div class="widget">
           <div class="widget-header">
           <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Model Struktur Pelupusan Aset Di Premis
            </div>
            </div>
             <input type='hidden' value='<?php echo $this->uri->segment(3); ?>' name='no' >
       		...
       		<div class="row-fluid">
                ...
                <!--start div panel pp -->
                    ...
                    <div class="widget-header">
                      <div class="title">
                        <span class="fs1" aria-hidden="true" data-icon="&#xe14C;"></span> PP
                      </div></div>
                       <div class="widget-body">
                      
                         <?php if(!empty($senarai_pp)) : foreach ($senarai_pp as $rec) : ?>
                                <div class="control-group">
                                    <label class="checkbox">
                                          <?php echo form_error('pp[]');?>
                   			 <input type="checkbox" value="<?php echo set_value('pp[]',$rec->utiliti_sumber_man_id); ?>" name="pp[]" >
                   			 <?php echo $rec->nama; ?>
                      ...
                      </div><!--end div panel pp -->
                
                <!--start div panel ptf -->
            		  <div class="span6">
            		  <div class="widget">
            		    <div class="widget-header">
            		      <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe14C;"></span> PTF</div>
          		        </div>
            		    <div class="widget-body">
                            ...
                            </div><!--end div row pp n ptf -->
                            
                        </div>
                
                <!--start div row pdf n pif -->
       			<div class="row-fluid">
                ...
                <!--start div panel pdf -->
                   ...
                   <div class="row-fluid">
       			   ...
       			   <div class="span6">
                            <div class="widget">
                            <div class="widget-header">
                            <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe14C;"></span> POF </div></div>
                            <div class="widget-body">
              ...
              <div class="row-fluid">
            	<div class="span12">
              	<div class="widget">
                <div class="widget-header">
                <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe14a;"></span> Ahli Lembaga Pemeriksaan (Pelulusan)</div></div>
                <div class="widget-body">
                  <!--start div widget body -->
                		<div class="widget-body">
                            ...
                            </a></li></ul><label class="tambah"> Tambah Lembaga Pemeriksaan</label>
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            <?php $i=1; if(!empty($senarai_lembagapemeriksa)) : foreach ($senarai_lembagapemeriksa as $rec) : ?>
                            <?php //echo form_open('admin/update'); ?>
                        
                            <tr>
                                <td align="left"><?php echo form_error('ahli_lembagapemeriksa[]'); ?><input type="checkbox" value="<?php echo set_value('ahli_lembagapemeriksa[]',$rec->utiliti_sumber_man_id); ?>" name='ahli_lembagapemeriksa[]' ></td>
                                <td align="left"><?php echo $i++; ?></td>
                                <td><?php if($get_nama_lembagapemeriksa = $this->pla_model->get_nama_lembagapemeriksa($rec->disiplin_bidang_id)) foreach ($get_nama_lembagapemeriksa as $rr) echo $rr->bidang;?></td>
                                <td><?php echo $rec->nama; ?></td>
                                <td><?php if($get_nama_lembagapemeriksa = $this->pla_model->get_syarikat($rec->syarikat_id)) foreach ($get_nama_lembagapemeriksa as $rr) echo $rr->nama_syarikat; ?></td>
                                <td align="center">
                                ...
                                <td align="center"><ul class="icomoon-icons-container"> <li class="rounded"><span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php base_url(); ?>kemaskini_lembagapemeriksa/<?php echo $rec->utiliti_sumber_man_id; ?>"></a>
                                    </span></li></ul>
                                </td>
                            </tr>
                            <?php //echo form_close(); ?>
            ...
            <!--start div pelan Komunikasi -->
              ...
              <div class="widget">
                <div class="widget-header">
                <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Panel Komunikasi Bagi Aktiviti Pelupusan Aset</div></div>
                <div class="widget-body">
               		<div class="control-group">
                     <font color="red"><?php echo form_error('pegawaikaitan'); ?></font> 
                     <label>Tugas Dan Pegawai Atasan Yang Ada Kaitan &nbsp;&nbsp;&nbsp;
                      <?php echo form_input(array('name' => 'pegawaikaitan', 'value' => set_value('pegawaikaitan', $this->session->userdata('pegawaikaitan')), 'class' => 'input-xxlarge')); ?>
                         </label>
                    </div>
                    <div class="control-group">
                     <font color="red"><?php echo form_error('tjawabdankuasa'); ?></font>  
                     <label>Tanggungjawab Dan Kuasa Yang Diberikan &nbsp;&nbsp;&nbsp;&nbsp;
                      <?php echo form_input(array('name' => 'tjawabdankuasa', 'value' => set_value('tjawabdankuasa', $this->session->userdata('tjawabdankuasa')), 'class' => 'input-xxlarge')); ?>
                     </label>
                    </div>
                    <div class="control-group">
                      <font color="red"><?php echo form_error('pegawailain'); ?></font> 
                      <label>Tugas Pegawai-Pegawai Lain Yang Ada Kaitan&nbsp;
                       <?php echo form_input(array('name' => 'pegawailain', 'value' => set_value('pegawailain', $this->session->userdata('pegawailain')), 'class' => 'input-xxlarge')); ?>
                      </label>
                     </div>
                  </div>
             	</div>
             ...
             <!-- </div> --> <!--end div pelan komunikasi -->
              ...
              <!--</div> -->
                ...
                <button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('pla/kandungan_pla/'.$this->uri->segment(3)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
         ...
         <!-- popup tambah ahli lembaga pemeriksa -->
         
          <form id="" class="" action="<?php echo site_url(); ?>/pla/tambah_lembagapemeriksa" method="post"> 
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-header">
                      ...
                      <h4 id="myModalLabel">
                        Tambah Ahli Lembaga Pemeriksaan (Pelulusan)
                      </h4>
                      </div>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><div class=""><select class="required large" name="disiplin">
                                                        ...
                                                        <option value="<?php echo $rec->disiplin_bidang_id; ?>"><?php echo set_value('disiplin', $rec->bidang); ?></option>
                                                        <?php endforeach; ?>
                                                        <?php endif; ?></select>
                                                    </div><br>
                                                  </td>
                                                ...
                                                <input type="hidden" name="sumber_id" value="2"> <input type="hidden" name="peranan" value="11">
