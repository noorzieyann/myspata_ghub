...
$kand_utama = array(
	...
	'kand_utama[3]'=>'Skop dan Aktiviti Pelupusan Aset',
	'kand_utama[4]'=>'Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset',
	'kand_utama[5]'=>'Kawalan Rekod Pelupusan Aset',
...
if($this->uri->segment(4) != NULL){
	foreach($this->pla_model->get_pla_from_segment($this->uri->segment(4)) as $row){
...
?>  
    ...
    <br /> 
    <?php 
	$form_name = 'pla/kandungan_pla/'.$this->uri->segment(3);
	if($this->uri->segment(4) != NULL){$form_name = 'pla/kandungan_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kandungan_pla');
          ...
          <div class="span12">
            <div class="widget">
              ...
              <div class="widget-body">
                  ...
                  <div class="control-group">
                      <label>
                       2.0 Objektif  <!-- <span class="popover-pop" data-original-title="2.0 Objektif" data-content="Menjelaskan matlamat pelupusan aset kementerian/ jabatan/ agensi." data-placement="right"  data-icon="&#xe0f7;"></span>-->
                      <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Menjelaskan matlamat pelupusan aset kementerian/ jabatan/ agensi." data-icon="&#xe0f7;"></a>
					  </label>                  
                  <div class="wysiwyg-container">
                      <?php
                  ...
                  <div class="control-group">
                      <label>3.0 Carta Organisasi Dan Pelan Komunikasi   <!--<span class="popover-pop" data-original-title="3.0 Carta Organisasi dan Pelan Komunikasi" data-content="Struktur organisasi dan pelan komunikasi perlu disediakan bagi menerangkan organisasi pelaksanaan pelupusan aset (Sebagaimana JKR.PATA.F8/1a)." data-placement="right" class="fs1" aria-hidden="true" data-icon="&#xe0f7;"></span>-->
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Struktur organisasi dan pelan komunikasi perlu disediakan bagi menerangkan organisasi pelaksanaan pelupusan aset (Sebagaimana JKR.PATA.F10/1a)." data-icon="&#xe0f7;"></a>
                      </label>    
                    <div class="wysiwyg-container">
                        <?php
                                $carta = $kand_detail[2];
                  ...
                  <div class="control-group">
                      <label>4.0 Skop Dan Pelupusan Aset Tak Alih  <!--<span class="popover-pop" data-original-title="4.0 Skop dan Aktiviti Penilaian Aset" data-content="PTF perlu menentukan/ menetapkan keperluan teknikal, proses, tempoh pelaksanaan, keperluan sumber, tanggungjawab dan kuasa pegawai yang terlibat bagi aktiviti berikut: (Sebagaimana JKR.PATA.F8/1b)" data-placement="right" data-icon="&#xe0f7;"></span>-->
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="PTF perlu menentukan/ menetapkan keperluan teknikal, proses, tempoh pelaksanaan, keperluan sumber, tanggungjawab dan kuasa pegawai yang terlibat bagi aktiviti berikut: (Sebagaimana JKR.PATA.F10/1b)" data-icon="&#xe0f7;"></a>
                  ...
                  <div class="control-group">
                      <label>5.0 Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset Tak Alih  <!--<span class="popover-pop" data-original-title="5.0 Penyediaan Keperluan Sumber Aktiviti Penilaian Aset" data-content="PTF hendaklah menyediakan Analisis Keperluan Sumber Aktiviti Penerimaan Aset bagi tujuan permohonan peruntukan (Sebagaimana JKR.PATA.F8/1c)." data-placement="right" data-icon="&#xe0f7;"></span>-->
					  <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="PTF hendaklah menyediakan Analisis Keperluan Sumber Aktiviti Pelupusan Aset Tak Alih bagi tujuan permohonan peruntukan (Sebagaimana JKR.PATA.F10/1c)." data-icon="&#xe0f7;"></a>
                    ...
                    <?php 
                     ...
                     echo form_textarea($data); ?>
                        <input type="hidden" name="kand_utama_sumber" value="Penyediaan Keperluan Sumber Aktiviti Pelupusan Aset Tak Alih">
                  ...
                  <div class="control-group">
                      ...
                      <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Kawalan rekod Pelupusan Aset Tak Alih sebagaimana JKR.PATA.F10/1d." data-icon="&#xe0f7;"></a>
                     </label>
                    <div class="wysiwyg-container">
                        <?php
                  ...
                  <div class="control-group">
                      ...
                      <a id="popoverOption" href="#"  
                      rel="popover" data-placement="top" data-original-title="Sebarang dokumen yang dirujuk dalam penyediaan PLA sebagaimana JKR.PATA.F10/1e." data-icon="&#xe0f7;"></a>
                     </label>
                    <div class="wysiwyg-container">
                        <?php
