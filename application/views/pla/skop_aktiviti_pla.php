                       ...
                       <?php $cnt=$this->skopaktiviti_model->get_lkpskopbutiran_count($rrr->skop_aktvt_id,'pla');
						...
						?>
                         ...
                         <?php if($getSko = $this->skopaktiviti_model->get_lkpskopbutiran($rrr->skop_aktvt_id,  $this->uri->segment(4),'pla')):
								...
								<td class="hidden-phone"><a href="<?php echo site_url()?>/pla/skop_aktiviti2_pla/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php  echo $rrq->skop_aktvt_id; ?>">
...
<?php $plaID = $this->uri->segment(4); ?>
                ...
                <div class="widget-body" align="right">
                  <a href="<?php echo site_url('pla/treeview_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('pla/kawalan_rekod_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
  ...
  <!--/.END tab section-->
    ...
    <!--/.END tab navigation-->
<?php echo form_open('pla/skop_aktiviti_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5)); ?>
