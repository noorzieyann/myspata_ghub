<!--breadcrumb-->
   ...
   <div class="clearfix"></div>
    ...
    <!--breadcrumb--><?php if(!empty($tab)) { echo $tab;} ?>
     ...
     <?php 
  $form_name = 'pla/dokumen_rujukan_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'pla/dokumen_rujukan_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'dokumen_rujukan_pla');
...
?>
        ...
        <!--popup-->
    <?php //echo form_open_multipart('pla/dokumen_rujukan_pla');?>
        ...
        <!--/.END popup-->
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table" >    
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('pla/muat_dokumen_rujukan_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>"><?php echo $rec->nama_fail_asal; ?></a></td>
                                <td align="center">
                                    <ul class="icomoon-icons-container">
                                    <a class="confirmation" href="<?php echo site_url('pla/hapus_dokumen_rujukan_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->lampiran_id);?>">
                                      <li class="rounded">
          ...
          <!--END panel 2-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('pla/summary_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
