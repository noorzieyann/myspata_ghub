...
<?php if(!empty($tab)) { echo $tab;} ?>
    <?php 
  $form_name = 'pla/kawalan_rekod_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
  if($this->uri->segment(5) != NULL){$form_name = 'pla/kawalan_rekod_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kawalan_rekod_pla_editppd');
...
?>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <ul class="icomoon-icons-container">
                           <li class="rounded">
                            <span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/pla/kemaskinikawalan_rekod_ppd/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->pla_pata_f10_1d_id; ?>">
                                        </a>
                                    </span></li></ul>
                                </td>
                            </tr>
        ...
        <!--/.END panel 1-->
                ...
                <a href="<?php echo site_url('pla/summary_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('pla/summary_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-warning2 input-top-margin" type="button">
                        Simpan
                      </button></a>
                     </div>
                     <!--end div button -->   
