      ...
      <div class="main-container">
              ...
              <div class="widget-body">
                    ...
                    <tbody>
                      <tr>
                        <td rowspan="2">
                          <span class="name">
                          1</span></td>
                        <td rowspan="2" class="hidden-phone">Aset Bangunan</td>
                        <td class="hidden-phone">Jualan</td>
                        <td rowspan="2" class="hidden-phone">Aktiviti 1</td>
                        <td class="hidden-phone">Butiran Aktiviti 1</td>
                        <td class="hidden-phone">120,000.00</td>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('pla/skop_aktiviti2_pla') ?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                    
                      </td>
                      </tr>
                      <tr>
                        <td class="hidden-phone">Hadiah</td>
                      ...
                      <tr>
                        <td rowspan="3">2</td>
                        <td rowspan="3" class="hidden-phone">Aset Infrastruktur</td>
                        <td class="hidden-phone">Pindah Milik</td>
                        ...
                        <li class="rounded"><a href="<?php echo site_url('pla/skop_aktiviti2_pla') ?>"<span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul></td>
                      </tr>
                      <tr>
                        <td class="hidden-phone">Pajakan</td>
                      ...
                      <tr>
                        <td class="hidden-phone">Tukar Guna</td>
                        <td class="hidden-phone">&nbsp;</td>
                        <td class="hidden-phone">&nbsp;</td>
                        <td class="hidden-phone">&nbsp;</td>
                        <td class="hidden-phone"></td>
                  ...
                  <div class="control-group">
                      <label class="control-label">
                        ...
                        <input class="input-large" type="text" placeholder="RM429,000.00" disable>
                      </label>
                   <br>
                   </div>
                  <!--/END pagination-->                             
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('pla/treeview_pla') ?>">
                  <button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button>
                  </a>
                  <a href="<?php echo site_url('pla/kawalan_rekod_pla') ?>">
                  <button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button>
                  </a>
