...
<?php if(!empty($tab)) { echo $tab;} ?>
    ...
    <div class="alert alert-block alert-info fade in">
      ...
      <?php 
        ...
        if($this->pla_model->get_status_summary($this->uri->segment(4)))
        { 
          $lengkap++;
        }


        if($this->pla_model->get_status_summary2($this->uri->segment(4)))
        {
          $lengkap = $lengkap+2;
        }


        if($this->pla_model->get_status_summary3($this->uri->segment(4)))
        {
          $lengkap++;
        }


        if($this->pla_model->get_status_summary4($this->uri->segment(4)))
        { 
          $lengkap++;
        }
...
<?php
$attributes = array('class' => 'form-horizontal no-margin','name'  => 'summary_pla','id'    => 'summary_pla');
echo form_open('pla/summary_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4),$attributes);
?>
            ...
            <table class="table table-condensed table-striped table-bordered table-hover no-margin">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="hidden-phone">
                    Model Struktur Pelupusan Aset di Premis (JKR.PATA.F10/1a)
                  </td>
                  

                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('pla/model_struktur_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('pla/treeview_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/edit') ?>">                         
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Kawalan Rekod Pelupusan Aset (JKR.PATA.F10/1d)
                  </td>
              
                  <td class="hidden-phone"> 
                    <a data-original-title="kemaskini" href="<?php echo site_url('pla/kawalan_rekod_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
                ...
                <tr>
                  ...
                  <td class="hidden-phone">
                    Dokumen Rujukan (JKR.PATA.F10/1e)
                  </td>
      
                  <td class="hidden-phone">
                    <a data-original-title="kemaskini" href="<?php echo site_url('pla/dokumen_rujukan_pla_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                      <ul class="icomoon-icons-container">
                        <li class="rounded">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe005;">
                          </span>
  ...
  <div class="next-prev-btn-container pull-right">
                ...
                <a type="button" class="btn btn-danger" href="<?php echo site_url('pla/senarai_ppd_pla/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>" data-toggle="modal">Batal</a>
