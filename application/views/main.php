              ...
              <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <dl class="dl-horizontal no-margin">
                      ...
                      <dd>
                        <?php if ($sesr['user_jabatan'] == '') {
                            echo '-';
							}else{

						 echo $sesr['user_jabatan']; }?>
...
$get_remarks = $this->utama_model->get_remarks($rec->notifikasi_id);                         

                        ?>
                          <a href="<?php echo site_url('main/update_status/'.$rec->notifikasi_id.'/'.$rec->notifikasi_url) ?>"><?php echo $get_titleNotifi . ' ' . $get_remarks; ?></a>
                    ...
                    <div class="clearfix">
                     ...
                     JUMLAH KESELURUHAN NOTIFIKASI BARU ADALAH SEBANYAK <span style="font-weight: bold;color:red"><?php echo $num_row;?></span> NOTIFIKASI. <a href="<?php echo site_url('main/senarai_keseluruhan_notifikasi')?>"><u>PAPARKAN KESELURUHAN NOTIFIKASI.</u></a>
                  </div>
                </div>
              </div>
            </div>
