...
$sessionarray = $this->session->all_userdata();
 ...
 if($this->uri->segment(4) != NULL){
   ...
   foreach($this->ptra_model->get_pelan_kom(($this->uri->segment(4))) as $row){
...
<!--breadcrumb-->
    ...
    <!--END breadcrumb-->
     <?php 
	$form_name = 'ptra/model_struktur_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
	if($this->uri->segment(5) != NULL){$form_name = 'ptra/model_struktur_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'model_struktur_ptra');
...
<?php echo validation_errors(); ?>
   ...
   <div class="clearfix"></div>
    ...
    <!--breadcrumb--><?php if(!empty($tab)) { echo $tab;} ?>
         <!--form action='<?php echo site_url(); ?>ptra/model_struktur_ptra/<?php echo $this->uri->segment(3); ?>' method='post'-->
           <!--start div panel Model struktur -->          
           <div class="row-fluid">
           <div class="span12">
           <div class="widget">
           <div class="widget-header">
           <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span> Model Struktur Organisasi Penerimaan Aset Di Premis 
            </div>
            </div>
                    ...
                    <div class="widget-header">
                      <div class="title">
                       ...
                       <div class="widget-body">
                        ...
                        $c = $this->ptra_model->get_count_data(($rec->utiliti_sumber_man_id),$this->uri->segment(4),4);
            		  ...
            		  <div class="widget">
            		    ...
            		    <div class="widget-body">
                                ...
                                <?php if(!empty($senarai_pif)) : foreach ($senarai_pif as $rec) : ?>
                                   <?php $c = $this->ptra_model->get_count_data(($rec->utiliti_sumber_man_id),$this->uri->segment(4),7);
                ...
                <?php echo form_error('pdf[]'); ?>
                            ...
                            <div class="widget-body">
                                 ...
                                 <?php if(!empty($senarai_pdf)) : foreach ($senarai_pdf as $rec) : ?>
                                    <?php $c = $this->ptra_model->get_count_data(($rec->utiliti_sumber_man_id),$this->uri->segment(4),5);
       			          ...
       			          <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe14C;"></span> POF</div>
                               ...
                               <div class="widget-body">
                                  ...
                                  <?php if(!empty($senarai_pof)) : foreach ($senarai_pof as $rec) : ?>
                                       <?php $c = $this->ptra_model->get_count_data(($rec->utiliti_sumber_man_id),$this->uri->segment(4),6);
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                      ...
                      <tbody>
                            ...
                            <tr>
                                <td align="left">
                              <?php $c = $this->ptra_model->get_count_panel(($rec->utiliti_sumber_man_id),$this->uri->segment(4));
                                //echo $c;
                            if($this->uri->segment(4) != NULL){
                               if($c > 0)//($rec->utiliti_sumber_man_id==$ptf)
                                { 
                            ...
                            ?> <label class="checkbox">
                               ...
                               <?php //echo $rec->nama; ?>
                                ...
                                <td><?php if($get_nama_panelpenilai = $this->ptra_model->get_nama_panelpenilai($rec->disiplin_bidang_id)) foreach ($get_nama_panelpenilai as $rr) echo $rr->bidang;?></td>
                                <td><?php echo $rec->nama; ?></td>
                                <td><?php if($getKem = $this->ptra_model->get_kem($rec->idkem)) foreach ($getKem as $rr) echo $rr->namakem;?></td>
                                <td><?php if($getjab = $this->ptra_model->get_jab_agensi($rec->idjab_agensi)) foreach ($getjab as $rr) echo $rr->nama_jab_agensi;?></td>
                                <td><?php if($getLevel = $this->ptra_model->get_level($rec->level_id)) foreach ($getLevel as $rr) echo $rr->level_desc;?></td>
                                
                                <td align="center">
                                  <ul class="icomoon-icons-container"> <li class="rounded"><span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="kemaskini" href="<?php echo site_url(); ?>/ptra/kemaskinipanel_penilai_ptra/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->utiliti_sumber_man_id; ?>"></a>
                                    </span></li></ul>
                            </tr>
                            <?php //echo form_close(); ?>
                            <?php endforeach; ?>
                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table2">    
                      <thead>
                        <tr>
                          ...
                          <th style="width:10%" class="hidden-phone">Surat Lantikan</th>
                          <th style="width:8%" class="hidden-phone">Tindakan</th>
                        </tr>
                      </thead>
                      <tbody>
                            ...
                            ?> <label class="checkbox">
                               ...
                               <?php //echo $rec->nama; ?>
                                ...
                                <td align="center">
                                    <ul class="icomoon-icons-container">
										<a title="Muat Turun" href="<?php echo site_url('ptra/muat_suratlantikan/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$rec->utiliti_sumber_man_id);?>">
                                ...
                                <td align="center">
                                  <ul class="icomoon-icons-container"> <li class="rounded"><span class="fs1">
                                        <a class="" aria-hidden="true" data-icon="&#xe005;" data-original-title="Kemaskini" href="<?php echo site_url(); ?>/ptra/kemaskinipanel_penilai_ptra2/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>/<?php echo $rec->utiliti_sumber_man_id; ?>"></a>
                                    </span></li></ul>
                            </tr>
                            <?php //echo form_close(); ?>
                            <?php endforeach; ?>
              ...
              <div class="widget">
                ...
                <div align="right">
                        ...
                        <a href="<?php echo site_url('ptra/senarai_ppd_ptra/'.$this->uri->segment(3))?>"><button class="btn btn-danger input-top-margin" type="button">
                                            Batal</button></a>
                     <a href="<?php echo site_url('ptra/kandungan_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
                    <?php /*
        $seterusnya = array(
...
<?php echo form_close(); ?>
         ...
         <!-- popup tambah panel penilai teknikal -->
                    ...
                    <?php echo form_open_multipart('ptra/model_struktur_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                             ...
                             <input type='hidden' value='<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5); ?>' name='param' >
                                <table width="95%" border="0" align="center">
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                   <td width="19%" valign="top">
                                                        <label class="control-label">Surat Lantikan<span class="required">*</span> <br/>(pdf sahaja)</label>
                                                   </td>
                                                   <td><div class="controls"><?php echo form_input(array('type' => 'file', 'name' => 'userfile', 'id' => 'userfile','class' => 'large required')); ?>
              ...
              <!-- </form>-->
 <?php //echo form_open_multipart('ptra/tambahsumbermanusia/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>
