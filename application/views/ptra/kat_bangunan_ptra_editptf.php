    ...
    <div id="home" class="tab-pane fade active in">
        ...
        <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'kat_bangunan_ptra_editptf',
                           'id' => 'kat_bangunan_ptra_editptf',
                        );
        echo form_open('ptra/kat_bangunan_ptra_editptf',$attributes); ?>
      <!--panel 2--> 
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
      ...
      <!--/.END main-container-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('ptra/summary_ptf_ptra_editptf')?>" class="btn btn-danger input-top-margin" id="error">
                    Batal
                  </a>
                  <a href="<?php echo site_url('ptra/summary_ptf_ptra_editptf')?>" class="btn btn-warning2 input-top-margin" id="simpan">
                    Simpan
                  </a>
                <!--/.END buttons-->
