              ...
              <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'summary_ptra_editpp',
                           'id' => 'summary_ptra_editpp',
                        );
                    echo form_open('ptra/summary_ptra_editpp',$attributes); ?>
      	 <!--panel 1-->  
         <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <a href="<?php echo site_url('ptra/status_premis_ptra_editpp')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>                
                        <td class="hidden-phone">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/model_struktur_ptra_editpp')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/treeview_ptra_editpp')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/kawalan_rekod_ptra_editpp')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>  
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/dokumen_rujukan_ptra_editpp')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>
                        <td class="hidden-phone">  
                          <span class="badge">
                            Deraf
                          </span>
  ...
  <!--/.END tab section-->
    ...
    <script type="text/javascript">
      ...
      $("lulus").onclick = function () {
        reset();
        alertify.confirm("Adakah ingin meluluskan rekod PTRA ID PTRA00002 ini?", function (e) {
          if (e) {
