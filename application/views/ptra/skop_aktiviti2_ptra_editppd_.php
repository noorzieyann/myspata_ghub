...
if($this->uri->segment(4) != NULL){
	if(count($this->ptra_model->get_ptra_skop_from_segment2(($this->uri->segment(4)),($this->uri->segment(5)))) == 0){
		...
		foreach($this->ptra_model->get_ptra_skop_from_segment2(($this->uri->segment(4)),($this->uri->segment(5))) as $row){
			//$kand_id[] = $row->kandungan_id;
			//$kand_detail[] = $row->kand_utama_detail;
                        $ptra_id=$row->ptra_id;
                        $skop_aktvt_id=$row->skop_aktvt_id;
                        $pihakkaitan=$row->f6_1b1c_pihak_berkaitan;
                        $tjawab=$row->f6_1b1c_tanggungjawab;
                        $tarikh_mula=$row->f6_1b1c_tarikh_mula;
                        $tarikh_akhir=$row->f6_1b1c_tarikh_tamat;
                        $catatan=$row->catatan;
...
<div class="widget-body">
     ...
     <br />
      <div class="widget-body">
                  <ul class="nav nav-tabs no-margin myTabBeauty">
                    ...
                    <li class="active"><a href="<?php echo site_url('ptra/senarai_ppd_ptra/'.$this->uri->segment(3))?>">PTRA</a></li>
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='ptra/skop_aktiviti2_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
	if($this->uri->segment(5) != NULL){$form_name = 'ptra/skop_aktiviti2_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_ptra_editppd');
	echo form_open($form_name, $attributes);
    ?>
    <?php 
	//echo form_hidden($skop_aktvt_id) ;
	//echo form_hidden($ptra_id) ;
	$sunting = array('sunting'=>NULL);
	if($this->uri->segment(4) != NULL){
		$sunting = array('sunting'=>$this->uri->segment(5));
		//echo form_hidden('ptra_pata_f6_1b1c_id',$ptra_pata_f6_1b1c_id);
	}
    ...
    <?php echo validation_errors(); ?>
              ...
              <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'skop_aktiviti2_ptra_editppd',
                           'id' => 'skop_aktiviti2_ptra_editppd',
                        );
                    echo form_open('ptra/skop_aktiviti2_ptra_editppd/'.$this->uri->segment(4).'/'.$this->uri->segment(5),$attributes); ?>
           ...
           <!--start div panel skop -->   
          	<div class="row-fluid">
                ...
                <div class="widget-body">
                   ...
                   <!--ptra_id = <?php //echo $this->uri->segment(3)?>
                   butiran aktiviti= <?php //echo $this->uri->segment(4) ?>
                   -->
                   <?php if($getSko = $this->ptra_model->get_lkpskopbutiran_1( $this->uri->segment(4),  $this->uri->segment(5)))  :foreach ($getSko as $rrq) :?>
                   <?php //echo $rrq->skop_aktvt_tajuk;?>
                   
                   
                   <?php if($getSko = $this->ptra_model->get_lkpskopaktiviti_1( $this->uri->segment(4), $rrq->skop_aktvt_sort=$this->uri->segment(5)))  :foreach ($getSko as $rr) :?>
		...
		<div class="span12">
                ...
                <div class="widget-body">
                    ...
                    <input type="hidden" value="<?php echo $this->uri->segment(4)?>" name="ptra_id"> 
              ...
              <div class="widget-body">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
							<select class="required large" name="objek">
                                ...
                                <option value="<?php echo $rec8->objek_sebagai_id; ?>" <?php if($objek ==$rec8->objek_sebagai_id ){ echo "selected"; }?> ><?php echo set_value('nama_jab_agensi', $rec8->objek_sebagai_kod. ':'.$rec8->objek_sebagai_teks); ?></option>
                                <?php endforeach; ?>
                                <?php endif; ?>
                    ...
                    <div class="controls">
                       <select class="required large" name="sumber">
                                ...
                                <option value="<?php echo $rec9->sumber_id; ?>" <?php if($sumber==$rec9->sumber_id){ echo "selected"; } ?> ><?php echo set_value('nama_jab_agensi', $rec9->sumber); ?></option>
                                <?php endforeach; ?>
                                <?php endif; ?>
                        </select>    
                        </div></div>
...
<!--start sumber manusia -->
    ...
    <!-- start rancang -->
                ...
                <div class="widget-body">
					...
					<?php // mymodal rancang begin here ?>
						...
						<div class="modal-body">
						  ...
						  <label class="radio"><input type="radio" name="kosflag<?php echo $count; ?>" id="optionsRadios" value="2">Gaji dan Kos Lebih Masa</label>
						   ...
						   <input type="hidden" name="ptra_id" value="<?php echo $this->uri->segment(4)?>">
					...
					<?php //end of mymodal rancang ?>
					
                    <?php if($this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5))== FALSE)
                            { 
                    ?>     	<label class="checkbox">
								<input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModal<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="planning" data-toggle="modal">
								<?php echo $rec->nama; ?> 
							</label>
                    <?php  
							}
                            ...
                            {
								$runQuery = $this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5));
								foreach ($runQuery as $rQ){$idExisting = $rQ->ptra_pata_f6_1b1c_sumber_man_id; }
								
                    ?>      	<input type="hidden" value="<?php echo $idExisting; ?>" name="txtrancang_sumberget" id="txtrancang_sumberget<?php echo $count; ?>"  />
								<label class="checkbox">
									<input type="checkbox" value="<?php echo set_value('ptf[]',$rec->utiliti_sumber_man_id); ?>" name="ptf[]" href="#myModal<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="planning" checked>
									<?php echo $rec->nama; ?>
									<?php 	
										if($this->ptra_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),1)== FALSE)
										{
                                			$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
										}
										else { $total= $total + $rec->gaji; }
								?>
								</label>
                    ...
                    <label>&nbsp;&nbsp;&nbsp;Kos (RM) <input class="input-small" value="<?php echo number_format($total,2);  ?>" id="txtRancang" name="txtRancang" /></label>
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $count=0; ?>
						...
						<?php //mymodal lulus begin here// ?>
							<div id="myModaly<?php echo $rec->utiliti_sumber_man_id ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-header">
								  ...
								  <h4 id="myModalLabel">Sila Kemaskini Maklumat Berikut</h4>
								</div>
								<div class="modal-body">
								  <p><label>Sila buat pemilihan untuk <?php echo $rec->nama; ?></label> 
						...
						<?php //end of mymodal lulus // ?>
						
                        <?php 
							if($this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5))== FALSE)
                            { 
                        ?>     
							<label class="checkbox">
                              <input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModaly<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="accepted"  data-toggle="modal">
                              <?php echo $rec->nama; ?> 
                            </label>
                        <?php  
							}
                            ...
                            {
								$runQuery = $this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5));
								foreach ($runQuery as $rQ){$idExisting = $rQ->ptra_pata_f6_1b1c_sumber_man_id; }		
                        ?>    
							<input type="hidden" value="<?php echo $idExisting; ?>" name="txtlulus_sumberget" id="txtlulus_sumberget<?php echo $count; ?>"  />
							<label class="checkbox">
                               <input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModaly<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="accepted" checked>
								<?php echo $rec->nama; ?>
								<?php 	if($this->ptra_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),1)== FALSE)
										{
											$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
										}
										else 
                     ...
                     <label>&nbsp;&nbsp;&nbsp;Kos (RM) <input class="input-small" value="<?php echo number_format($total,2);  ?>" name="txtLulus" id="txtLulus" /></label>
    ...
    <!-- start isi-->
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
						...
						<?php //end of mymodal isi ?>
						
						<?php 	if($this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5))== FALSE)
                                { 
                        ?>     
									<label class="checkbox">
										<input type="checkbox" value="<?php echo set_value('ptf[]',$rec->utiliti_sumber_man_id); ?>" name="ptf[]" href="#myModalx<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="proceed"  data-toggle="modal">
										<?php echo $rec->nama; ?> 
									</label>
                        <?php  	}
								else 
								{
									$runQuery = $this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5));
									foreach ($runQuery as $rQ){$idExisting = $rQ->ptra_pata_f6_1b1c_sumber_man_id; }
                        ?>      
									<input type="hidden" value="<?php echo $idExisting; ?>" name="txtisi_sumberget" id="txtisi_sumberget<?php echo $count; ?>"  />
									<label class="checkbox">
									   <input type="checkbox" value="<?php echo $rec->utiliti_sumber_man_id; ?>" name="ptf[]" href="#myModal3<?php echo $rec->utiliti_sumber_man_id ?>" id="<?php echo $count; ?>" class="proceed"  checked>
										<?php 	echo $rec->nama; ?>
										<?php 	if($this->ptra_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),3,$this->uri->segment(5),1)== FALSE)
												{
													$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
												}
												else { $total= $total + $rec->gaji; }
                     ...
                     <label>&nbsp;&nbsp;&nbsp;Kos (RM) <input class="input-small" value="<?php echo number_format($total,2);  ?>" id="txtIsi" name="txtIsi" /></label>
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calVal = 0; $count=1; if(!empty($senarai_alat_pej)) : foreach ($senarai_alat_pej as $rec1) : ?>
									...
									<?php if($checkPjbt = $this->ptra_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec1->urus_pej_id,$rec1->kat_alat_pej_id)) { echo "checked"; } 
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                         ...
                         <?php $calValFax=0; $autoNumb=1; if(!empty($senarai_fax)) : foreach ($senarai_fax as $rec2) : ?>
							...
							<?php if($checkPjbt = $this->ptra_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec2->urus_pej_id,$rec2->kat_alat_pej_id)) { echo "checked"; } 
                ...
                <div class="widget-body">
                  ...
                  <label class="checkbox">
                         ...
                         <label class="checkbox">
							  ...
							  <?php if($checkPjbt = $this->ptra_model->get_total_pejabat($this->uri->segment(4),$this->uri->segment(5),$rec3->urus_pej_id,$rec3->kat_alat_pej_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKom=0; $count=1; if(!empty($senarai_kom)) : foreach ($senarai_kom as $rec4) : ?>
                          <label class="checkbox">
							 ...
							 class="machKom" 
							 <?php if($checkAlat = $this->ptra_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec4->alat_kerja_id,$rec4->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValPeriksa=0; $count=1; if(!empty($senarai_pemeriksa)) : foreach ($senarai_pemeriksa as $rec7) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->ptra_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec7->alat_kerja_id,$rec7->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <div class="overview">
                         ...
                         <?php $calValKend=0; $count=1; if(!empty($senarai_kenderaan)) : foreach ($senarai_kenderaan as $rec5) : ?>
                          ...
                          <label class="checkbox">
							  ...
							  <?php if($checkAlat = $this->ptra_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec5->alat_kerja_id,$rec5->kat_alat_kerja_id)) { echo "checked"; } 
	...
	<!-- start PPE -->
 		<div class="span3">
                ...
                <div class="widget-body">
                         ...
                         <?php $calValPPE=0; $count=1; if(!empty($senarai_ppe)) : foreach ($senarai_ppe as $rec6) : ?>
                            ...
                            <label class="checkbox">
                             <input id="ppe<?php echo $count; ?>" type="checkbox" value="<?php echo $rec6->alat_kerja_id; ?>cb<?php echo $rec6->kos_seunit; ?>" name="ppe[]"
							  ...
							  <?php if($checkAlat = $this->ptra_model->get_total_peralatan($this->uri->segment(4),$this->uri->segment(5),$rec6->alat_kerja_id,$rec6->kat_alat_kerja_id)) { echo "checked"; } 
                    ...
                    <!--start div button -->
                <div align="right">
                <a href="<?php echo site_url('ptra/skop_aktiviti_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Kembali
                  </button></a>
                     <!--<a href="<?php echo site_url('ptra/summary_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>"><button class="btn btn-warning2 input-top-margin" type="button">                       Simpan
                      </button></a>-->
...
$(document).ready(function(){ 
	$('.planning').click(function(){
		...
		{ 
			...
			$.ajax({
                type: "POST",
                url: "<?php echo site_url(); ?>/ptra/set_skop_aktiviti_ptra/"+jgk, 
