 <!--yann 271113-->
 <?php 
  $form_name = 'ptra/kat_saliran_ptra_copy/'.$this->uri->segment(3);
  if($this->uri->segment(4) != NULL){$form_name = 'ptra/kat_saliran_ptra_copy/'.$this->uri->segment(3).'/'.$this->uri->segment(4);}
  $attributes = array('class' => 'form-horizontal no-margin', 'id' => 'kat_saliran_ptra_copy');
            ...
            <div class="span12">
              <div class="widget">
               ...
               <div class="widget-body">
                  ...
                  <input type="hidden"  name="premis" value="4">
               </div>
              </div>
            </div>
          </div>
