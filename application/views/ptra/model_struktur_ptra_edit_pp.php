...
<?php 
	$form_name = 'ptra/model_struktur_ptra_edit_pp';
	
  if($this->uri->segment(4) != NULL)
  {
    $form_name = 'ptra/skop_aktiviti2_ptra_edit_pp/'.$this->uri->segment(4);
  }

	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_ptra_edit_pp');
...
<div class="tab-content" id="myTabContent">
  <div id="home" class="tab-pane fade active in">
    <p>
      <form action='<?php echo site_url(); ?>ptra/skop_aktiviti2_ptra_edit_pp/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4); ?>' method='post'>
        ...
        <div class="row-fluid">
          <div class="span12">
            <div class="widget">
                    ...
                    <div class="span6">
                      <div class="widget">
                        ...
                        <div class="widget-body">
                          ...
                          <?php 
                                if(!empty($senarai_ptf)) : foreach ($senarai_ptf as $rec) : ?>
                                  <?php if($this->ptra_model->get_model_ptf(($rec->utiliti_sumber_man_id),$this->uri->segment(4))== FALSE)
                                  { 
                                    echo ''; 
                          ?>     
              ...
              <!-- div panel penilai teknikal START -->
              <div class="row-fluid">
                <div class="span12">
                  <div class="widget">
                    <div class="widget-header">
                          ...
                          <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
                            ...
                            <?php //echo form_open('admin/update'); ?>
                              ...
                              <tr>
                                ...
                                <?php if($this->ptra_model->get_model_panel(($rec->utiliti_sumber_man_id),$this->uri->segment(4))== FALSE)
                                      { 
                                        echo ''; 
                                ...
                                <td>
                                  <?php if($get_nama_panelpenilai = $this->ptra_model->get_nama_panelpenilai($rec->disiplin_bidang_id)) foreach ($get_nama_panelpenilai as $rr) echo $rr->bidang;?>
                                </td>
                                ...
                                <td>
                                  <?php if($get_nama_panelpenilai = $this->ptra_model->get_syarikat($rec->syarikat_id)) foreach ($get_nama_panelpenilai as $rr) echo $rr->nama_syarikat; ?>
                                </td>
                                ...
                                <td class="hidden-phone">
                                  <a href="<?php echo site_url('ptra/papar_panel_penilai_pp/'.$this->uri->segment(3).'/'.$this->uri->segment(4)).'/'.$rec->utiliti_sumber_man_id; ?>">                         
                                    <ul class="icomoon-icons-container">
                                      <li class="rounded">
                                        <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                        </span>
                      ...
                      <div class="span12">
                        <div class="widget">
                          <div class="widget-header">
                            <div class="title">
                              <span class="fs1" aria-hidden="true" data-icon="&#xe022;">
                              </span> Panel Komunikasi Bagi Aktiviti Penilaian Aset
                            </div>
                          </div>
                          ...
                          <?php $i=1; if(!empty($pelan_kom)) : foreach ($pelan_kom as $rec1) : ?>
                            ...
                            <div class="control-group">
                              <label>Tugas Dan Pegawai Atasan Yang Ada Kaitan &nbsp;&nbsp;&nbsp;
                                <?php echo form_input(array('class="span6 input-left-top-margins" readonly="readonly"','name' => 'tjawabdankuasa', 'value' => set_value('tjawabdankuasa', $rec1->tugas_pegawai_atasan))); ?>
                              </label>
                            </div>
                            ...
                            <div class="control-group">
                              <label>Tanggungjawab Dan Kuasa Yang Diberikan &nbsp;&nbsp;&nbsp;&nbsp;
                                <?php echo form_input(array('class="span6 input-left-top-margins" readonly="readonly"','name' => 'tjawabdankuasa', 'value' => set_value('tjawabdankuasa', $rec1->tugas_pegawai_tjawab_kuasa))); ?>
                              </label>
                            </div>
                            ...
                            <div class="control-group">
                              <label>Tugas Pegawai-Pegawai Lain Yang Ada Kaitan&nbsp;
                                <?php echo form_input(array('class="span6 input-left-top-margins" readonly="readonly"','name' => 'pegawailain', 'value' => set_value('pegawailain', $rec1->tugas_pegawai_lain))); ?>
                              </label>
                            </div>
            ...
            <input type='hidden' value='<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4); ?>' name='pnpa_id'/>
              ...
              <!-- div button START -->
              <div align="right">
                <a href="<?php echo site_url('pnpa/summary_pp_pnpa/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">
