        ...
        <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'summary_ptra_editppd',
                           'id' => 'summary_ptra_editppd',
                        );
                    echo form_open('ptra/summary_ptra_editppd',$attributes); ?>
      	 <!--panel 1-->  
         <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <a href="<?php echo site_url('ptra/status_premis_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>                
                        <td class="hidden-phone">
    ...
    <!--/.END popup rujukan-->
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/model_struktur_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/treeview_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/kawalan_rekod_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>  
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <a href="<?php echo site_url('ptra/dokumen_rujukan_ptra_editppd')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>
                        <td class="hidden-phone">  
                          <span class="badge">
                            Deraf
                          </span>
        ...
        <!--/.END panel 4-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('ptra/senarai_ppd_ptra')?>" class="btn btn-danger input-top-margin" id="error">
                    Batal
                  </a>
    ...
    <!-- ALERT -->
     <script type="text/javascript">
      ...
      $("simpan").onclick = function () {
        reset();
        alertify.confirm("Adakah ingin menyimpan Pelan Penerimaan Aset ini?", function (e) {
          if (e) {
              
              document.forms["summary_ptra_editppd"].submit();
