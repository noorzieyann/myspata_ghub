    ...
    <div id="home" class="tab-pane fade active in">
      <?php 
                    $attributes = array(
                        'class' => 'form-horizontal no-margin', 
                         'name' => 'status_premis_ptra_editptf',
                           'id' => 'status_premis_ptra_editptf',
                        );
                    echo form_open('ptra/status_premis_ptra_editptf',$attributes); ?>
      <!--main container-->
     ...
     <!--buttons--> 
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('ptra/kat_bangunan_ptra_editptf')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Seterusnya
                  </button></a>
                </div> 
                <!--/.END buttons--> 
