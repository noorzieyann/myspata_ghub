...
<div class="widget-body">
  ...
  <?php
    $attributes = array('class' => 'form-horizontal no-margin',
                        'name'  => 'summary_ptf_ptra',
                        'id'    => 'summary_ptf_ptra'
                       );

    echo form_open('ptra/summary_ptf_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4),$attributes);
  ?>
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                          <a href="<?php echo site_url('ptra/model_struktur_ptra_editptf/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                       
                            <ul class="icomoon-icons-container">
                              <li class="rounded">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                          <a href="<?php echo site_url('ptra/skop_aktiviti_ptra_editptf/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                            <ul class="icomoon-icons-container">
                              <li class="rounded">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                          <a href="<?php echo site_url('ptra/kawalan_rekod_ptra_editptf/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                        
                            <ul class="icomoon-icons-container">
                              <li class="rounded">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                          <a href="<?php echo site_url('ptra/dokumen_rujukan_ptra_editptf/'.$this->uri->segment(3).'/'.$this->uri->segment(4)) ?>">                         
                            <ul class="icomoon-icons-container">
                              <li class="rounded">
                                <span class="fs1" aria-hidden="true" data-icon="&#xe026;">
                                </span>
...
<!-- modal pengesahan sah START -->         
 ...
 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> ×</button>
 <h4 id="myModalLabel">Mesej Pengesahan</h4></div>
 <div class="modal-body"><p>Adakah anda ingin mengesahkan PTRA ini?</p></div>
