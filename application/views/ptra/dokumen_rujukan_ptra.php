...
<div class="row-fluid">
  ...
  <div class="widget-body" align="right">
    <a href="<?php echo site_url('ptra/senarai_ppd_ptra/'.$this->uri->segment(3))?>">
      <button class="btn btn-danger input-top-margin" type="button">
        Batal
      </button>
    </a>
    
    <a href="<?php echo site_url('ptra/kawalan_rekod_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>">
    ...
    <a type="button" class="btn btn-warning2" href="#simpan" data-toggle="modal">
      Simpan Deraf
    </a>
  </div> 
  <!-- buttons END --> 
