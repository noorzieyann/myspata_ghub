...
//if(option == 'foto')
//{
//	var txttotal = document.getElementById('txttotal2');
//}
//else if(option == 'fax')
//{
//	var txttotal = document.getElementById('txtFax');
//}
//else if(option == 'tel')
//{
//	var txttotal = document.getElementById('txtTel');
//}
...
<div class="widget-body">
    ...
    <!--breadcrumb-->
    <?php 
	$form_name ='ptra/skop_aktiviti2_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);
	//if($this->uri->segment(4) != NULL){$form_name = 'ptra/skop_aktiviti2_ptra/'.$this->uri->segment(4);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'skop_aktiviti2_ptra');
    ...
    <?php echo validation_errors(); ?>
              ...
              <?php /*
                    ...
                    echo form_open('ptra/skop_aktiviti2_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),$attributes); */ ?>
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb=0; ?>
                        ...
                        <?php 	
							if($this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5))== FALSE)
							{ 
								echo ''; 
								?>    
                       ...
                       ?>    
                            ...
                            <?php if($this->ptra_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),1,$this->uri->segment(5),1)== FALSE)
								{
                ...
                <div class="widget-body">
                    ...
                    <div class="overview">
                 	 <?php $total=0; $run_numb2=0; ?>
                        <?php if(!empty($senarai_sumber)) : foreach ($senarai_sumber as $rec) : ?>
                        <?php if($this->ptra_model->get_sumber_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5))== FALSE)
                                { 
                                 echo ''; 
                       ...
                       <?php 
								...
								if($this->ptra_model->get_total_rancang(($rec->utiliti_sumber_man_id),$this->uri->segment(4),2,$this->uri->segment(5),1)== FALSE)
								{
									$total= $total + $rec->gaji+ $rec->kos_kerja_lebih_masa;
                                }
                                else 
...
<!-- start pengurusan pejabat-->   
             ...
             <div class="span4">
                ...
                <button class="btn btn-danger input-top-margin" type="button">
                     ...
                     <a href="<?php echo site_url('ptra/skop_aktiviti_ptra/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.'edit') ?>"><button class="btn btn-primary input-top-margin" type="button">
                        Sebelum
                      </button></a>
