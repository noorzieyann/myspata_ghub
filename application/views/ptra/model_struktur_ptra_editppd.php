...
<!--breadcrumb-->
    ...
    <!--END breadcrumb-->
     <?php 
	$form_name = 'ptra/model_struktur_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4);
	if($this->uri->segment(5) != NULL){$form_name = 'ptra/model_struktur_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);}
	$attributes = array('class' => 'form-horizontal no-margin', 'id' => 'model_struktur_ptra_editppd');
...
<?php echo form_close(); ?>
         <!-- popup tambah panel penilai teknikal -->
                    ...
                    <?php echo form_open_multipart('ptra/model_struktur_ptra_editppd/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>
