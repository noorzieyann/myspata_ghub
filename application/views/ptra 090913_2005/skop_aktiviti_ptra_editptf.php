      ...
      <div class="main-container">
                ...
                <div class="widget-body">                 
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">12,000.00</td>
                        ...
                        <a href="<?php echo site_url('ptra/skop_aktiviti2_ptra_editptf')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul>                    
                      </td>
                      </tr>
                      <tr>
                        <td class="hidden-phone">Butiran Aktiviti  2</td>
                        <td class="hidden-phone">8,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                        ...
                        <a href="<?php echo site_url('ptra/skop_aktiviti2_ptra_editptf')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></li></a></ul></td>
                      </tr>
                      <tr>
                        <td rowspan="5">2</td>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">21,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-inverse">
                            Pembetulan
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">9,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">17,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-inverse">
                            Pembetulan
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">15,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">18,000.00</td>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                  ...
                  <div class="control-group">
                      ...
                      <label>Jumlah Bajet Aktiviti (RM)&nbsp;
                        <input class="input-large" type="text" placeholder="89,000.00" disabled>
                      </label>
                     </div>                     
                  </div>  
                  <!--/.END-->                    
        ...
        <!--/.END panel 1-->
                ...
                <div class="widget-body" align="right">
                  ...
                  <a href="<?php echo site_url('ptra/treeview_ptra_editptf')?>"><button class="btn btn-primary input-top-margin" type="button">
                    Sebelum
                  </button></a>
                  <a href="<?php echo site_url('ptra/summary_ptf_ptra_editptf')?>"><button class="btn btn-warning2 input-top-margin" type="button">
                    Simpan
                  </button></a>
                </div> 
                <!--/.END buttons-->   
