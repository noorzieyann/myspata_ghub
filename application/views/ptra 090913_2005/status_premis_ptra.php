            ...
            <div class="span12">
              <div class="widget">
               ...
               <div class="widget-body">
                  ...
                  <label class="radio">
                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
                    <a href = "<?php echo site_url('ptra/kat_jalan_ptra')?>">Jalan</a>
                  </label>
                  <label class="radio">
                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1">
                    <a href = "<?php echo site_url('ptra/kat_pembetungan_ptra')?>">Pembetungan</a>
                  </label>
                  <label class="radio">
                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
                    <a href = "<?php echo site_url('ptra/kat_saliran_ptra')?>">Saliran</a>
                  </label>
                </div>                
              </form>
               </div>
