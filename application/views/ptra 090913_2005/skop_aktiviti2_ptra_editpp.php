  ...
  <div class="main-container">
     ...
     <!--/.END big panel-->
                ...
                <div class="widget-body" align="right">
                    <a href="<?php echo site_url('pnpa/summary_pp_ptra_editpp') ?>"><button class="btn btn-danger input-top-margin" type="button">
                  Batal
                  </button></a>
                  <a href="<?php echo site_url('ptra/skop_aktiviti_ptra_editpp')?>"><button class="btn btn-warning2 input-top-margin" type="button">
                    Simpan
                  </button></a>
                </div> 
                <!--/.END buttons--> 
