    ...
    <!--/.END status info-->
      ...
      <div class="main-container">
        ...
        <?php 
                    ...
                    echo form_open('ptra/summary_pp_ppun',$attributes); ?>
      	 <!--panel 1-->  
         <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <a href="<?php echo site_url('ptra/status_premis_ptra')?>"><li class="rounded"><span class="fs1" aria-hidden="true" data-icon="&#xe026;"></span></li></a></ul>                
                        <td class="hidden-phone">
