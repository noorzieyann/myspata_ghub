    ...
    <!--/.END status info-->
      ...
      <div class="main-container">
        ...
        <?php 
                    ...
                    echo form_open('ptra/summary_ptra',$attributes); ?>
      	 <!--panel 1-->  
         <div class="row-fluid">
            <div class="span12">
              <div class="widget">
    ...
    <!--/.END popup rujukan-->
                  ...
                  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="hidden-phone">                       
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('ptra/model_struktur_ptra_editppd')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>                
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('ptra/treeview_ptra_editppd')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>
                        <td class="hidden-phone">
                          <span class="badge badge-success">
                            Lengkap
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('ptra/kawalan_rekod_ptra_editppd')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>  
                        <td class="hidden-phone">
                          <span class="badge">
                            Deraf
                          </span>
                      ...
                      <tr>
                        ...
                        <td class="hidden-phone">                         
                        <ul class="icomoon-icons-container">
                        <li class="rounded"><a href="<?php echo site_url('ptra/dokumen_rujukan_ptra_editppd')?>"><span class="fs1" aria-hidden="true" data-icon="&#xe005;"></span></a></li></ul>
                        <td class="hidden-phone">  
                          <span class="badge">
                            Deraf
                          </span>
        ...
        <!--/.END panel 4-->
                ...
                <div class="widget-body" align="right">
                    ...
                    <a href="<?php echo site_url('ptra/dokumen_rujukan_ptra')?>" class="btn btn-primary input-top-margin" id="button">
                    Sebelum
                  </a>
      ...
      $("simpan").onclick = function () {
        ...
        alertify.confirm("Adakah ingin menyimpan Pelan Penerimaan Aset ini?", function (e) {
          if (e) {
              ...
              //document.forms["summary_ptra_edit"].submit();
