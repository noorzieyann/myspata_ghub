...
echo form_open('pspao/senarai_pspao_akhir_ptf_2',$attributes); 
echo '
...
<?php // ULASAN -END-   ?>
        ...
        <button class="btn btn-success" type="button" id="confirm"> Sah </button>
...
<script>
    ...
    $('#nowucme17').wysihtml5();
      ...
      $("confirm").onclick = function () {
        reset();
        alertify.confirm("Adakah ingin mengesahkan PSPA(O) Akhir?", function (e) {
          if (e) {
            alertify.success("Pengesahan berjaya dihantar");
			window.location.replace("<?php echo site_url('pspao/pspao_akhir') ?>");
          } else {
            alertify.error("Pengesahan dibatalkan");
          }
        });
        return false;
      };
