...
echo form_open('pspao/pspao_akhir_baru_4',$attributes); 
echo '
...
<?php */// ULASAN -END-   ?>
        ...
        <button class="btn btn-primary" type="button"> Simpan Deraf </button>
      ...
      $("confirm").onclick = function () {
        ...
        alertify.confirm("Adakah ingin menghantar borang PSPA(O) Akhir untuk pengesahan?", function (e) {
          if (e) {
			...
			window.location.replace("<?php echo site_url('pspao/senarai_pspao_akhir_ptf') ?>");
          } else {
