...
function return_modal($ids,$tajuk,$body,$kalobetul){
...
?>                      
                      <?php echo return_modal($dat->kandungan_id, $dat->kand_utama , $bondy, $kalobetul) ?>
...
?>
         ...
         <!--/.END panel 4-->
             ...
             <div class="next-prev-btn-container pull-right">
                ...
                <a type="button" class="btn btn-warning2" href="#hantar" data-toggle="modal">Sah</a> 
                <?php
						}
					}
				?>
...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> ×</button>
<h4 id="myModalLabel">Mesej Pengesahan</h4></div>
<div class="modal-body"><p>Adakah anda ingin mengesahkan PSPA(O) Akhir ini?</p></div>
 	<!--button-->
  	<div class="modal-footer">
	<?php
		$batal = array(
		...
		echo form_button($batal);
		echo form_submit('hantar', 'Sah','class="btn btn-warning2"');
	?>
