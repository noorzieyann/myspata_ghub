...
if($this->uri->segment(3) != NULL){
	foreach($this->pspao_akhir_model->get_pspao_awal_from_segment($this->uri->segment(3)) as $row){
...
<?php 
	...
	if($this->uri->segment(3) != NULL){$form_name = 'pspao/pspao_akhir_baru_dariawal/'.$this->uri->segment(3);}
