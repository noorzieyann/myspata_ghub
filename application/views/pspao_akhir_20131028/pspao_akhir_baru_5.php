...
<?php ///////////////////  END  MODAL SINI JAH ////////////////////////////  ?>
                ...
                <div class="next-prev-btn-container pull-right">
                    <a href="<?php echo site_url('pspao/pspao_akhir_baru_4/'.$this->uri->segment(3)) ?>"><button class="btn btn-danger input-top-margin" type="button"> Batal </button></a>
                    <a href="<?php echo site_url('pspao/pspao_akhir_baru_4/'.$this->uri->segment(3)) ?>"><button class="btn btn-primary" type="button"> Sebelum </button></a>
                    <a href="<?php echo site_url('pspao/pspao_akhir_baru_4/'.$this->uri->segment(3)) ?>"><button class="btn btn-primary" type="button"> Seterusnya </button></a>
            	</div>
