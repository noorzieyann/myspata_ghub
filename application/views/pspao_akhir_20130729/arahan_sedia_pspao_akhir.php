          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <div class="widget-body">
                  <form class="form-horizontal no-margin" action="<?php echo site_url('main/senarai_template_pspao_awal') ?>">
              
                   <div class="widget">
                     <div class="widget-header">
                      <div class="title"><span class="fs1" aria-hidden="true" data-icon="&#xe022;"></span>Penerimaan Arahan Penyediaan</div>
                     </div>
                ...
                <input name="Hantar" type="submit" value="Hantar" class="btn btn-success" id="alert" />
...
<script type="text/javascript">
      ...
      $("alert").onclick = function () {
        reset();
        alertify.alert("Borang Berjaya dihantar!");
        return false;
      };
</script>